...
class DeliverymanController extends Controller
{
    ...
    public function get_profile(Request $request)
    {
        ...
        // $dm['Payable_Balance'] =(float)( $dm['balance']  - $dm?->wallet?->collected_cash < 0 ? abs($dm['balance'] - $dm?->wallet?->collected_cash): 0 );
        //
        ...
        // dd($dm['balance'] , $cash_in_hand_overflow ,$cash_in_hand_overflow_delivery_man, $val  );
