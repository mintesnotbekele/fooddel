...
class ConfigController extends Controller
{
    ...
    public function configuration()
    {
        ...
        return response()->json([
            ...
            'base_urls' => [
                ...
                'customer_image_url' => asset('storage/app/profile'),
                'banner_image_url' => asset('storage/app/banner'),
                'category_image_url' => asset('storage/app/category'),
                'cuisine_image_url' => asset('storage/app/cuisine'),
                'review_image_url' => asset('storage/app/review'),
                'notification_image_url' => asset('storage/app/notification'),
                'restaurant_image_url' => asset('storage/app/restaurant'),
                'vendor_image_url' => asset('storage/app/vendor'),
                'restaurant_cover_photo_url' => asset('storage/app/restaurant/cover'),
                'delivery_man_image_url' => asset('storage/app/delivery-man'),
                'chat_image_url' => asset('storage/app/conversation'),
                'campaign_image_url' => asset('storage/app/campaign'),
                'business_logo_url' => asset('storage/app/business'),
                'react_landing_page_images' => asset('storage/app/react_landing') ,
                'react_landing_page_feature_images' => asset('storage/app/react_landing/feature') ,
                'refund_image_url' => asset('storage/app/refund'),
                'gateway_image_url' => asset('storage/app/payment_modules/gateway_image'),
                'order_attachment_url' => asset('storage/app/order'),
    ...
    public function react_landing_page()
    {
        ...
        return  response()->json(
            [
                'base_urls' => [
                    'react_header_image_url' => asset('storage/app/react_header'),
                    'react_services_image_url' => asset('storage/app/react_service_image'),
                    'react_promotional_banner_image_url' => asset('storage/app/react_promotional_banner'),
                    'react_delivery_section_image_url' => asset('storage/app/react_delivery_section_image'),
                    'react_restaurant_section_image_url' => asset('storage/app/react_restaurant_section_image'),
                    'react_download_apps_banner_image_url' => asset('storage/app/react_download_apps_image'),
                    'react_download_apps_image_url' => asset('storage/app/react_download_apps_image'),
                ],
