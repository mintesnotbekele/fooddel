                                    ...
                                    <div class="btn--container justify-content-center">
                                        ...
                                        @else
                                            @if($dm->status != 'canceled')
                                                <a class="btn btn-sm btn--danger btn-outline-danger action-btn action-btn-section" href="{{route('admin.dm-disbursement.change-status', ['id'=>$dm->id,'status'=>'canceled'])}}" data-toggle="tooltip" title="{{ translate('cancel') }}">
                                                    <i class="tio-clear"></i>
                                                </a>
                                            @endif
