                                ...
                                <div class="swiper mySwiper pb-3">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="{{asset('assets/admin/img/slider-1.png')}}" loading="lazy"
                                                alt="" class="dark-support rounded">
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                {{-- <img src="{{asset('assets/admin/img/slider-2.png')}}" loading="lazy"
                                        ...
                                        <div class="swiper-slide">
                                            <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                <img src="{{asset('assets/admin/img/slider-3.png')}}" loading="lazy"
                                                    alt="" class="dark-support rounded mb-4">
                                                <p>
                        ...
                        <div class="col-sm-6 col-lg-5 col-xl-4 col-xxl-3">
                            ...
                            <div class="uploadDnD">
                                <div class="form-group inputDnD">
                                    ...
                                    id="inputFile" onchange="readUrl(this)" accept=".zip" data-title="{{ translate('Drag_&_drop_file_or_Browse_file') }}">
                                </div>
                            </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-4 px-sm-5 text-center">
                                                ...
                                                <div class="btn--container justify-content-center">
                                                    ...
                                                    <button type="submit" class="btn btn--cancel min-w-120" data-dismiss="modal" onclick="theme_delete('{{$addon}}')">{{ translate('delete') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-4 px-sm-5 text-center">
                                                ...
                                                <div class="btn--container justify-content-center">
                                                    ...
                                                    <button type="button" class="btn btn--primary min-w-120" data-dismiss="modal" onclick="publish_addon('{{$addon}}')">{{ translate('yes') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
