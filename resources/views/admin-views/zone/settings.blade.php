        ...
        <form action="{{ route('admin.zone.zone_settings_update', $zone->id) }}" method="post" class="card p-0 border-0 shadow--card">
            ...
            <div class="card-header">
                <h5 class="card-title align-items-center">
                    ...
                    <img src="{{asset('/assets/admin/img/info-circle.svg')}}" data-toggle="tooltip" title="{{ translate('messages.Set_zone_wise_delivery_charges_for_this_business_zone')}}" alt="">
                </h5>
            </div>
        ...
        <div class="card shadow--card border-0 mt-3 p-0">
            <div class="card-header flex-wrap __gap-5px">
                <h5 class="card-title align-items-center">
                    ...
                    <img src="{{asset('/assets/admin/img/info-circle.svg')}}" data-toggle="tooltip" title="{{ translate('messages.Set_the_daily_earning_target_and_the_incentive_upon_completing_the_target.') }}" alt="">
                </h5>
            </div>
                    ...
                    <div class="single-item-slider owl-carousel">
                        <div class="item">
                            <div class="max-544 mx-auto mb-20 text-center">
                                <img src="{{asset('/assets/admin/img/modal/zone1.png')}}" alt="" class="mb-20">
