...
<div class="card-header">
    <h5 class="card-header-title">
        <img src="{{asset('/assets/admin/img/dashboard/top-resturant.png')}}" alt="dashboard" class="card-header-icon">
    ...
    @foreach($top_restaurants as $key=>$item)
        <li>
            <div class="top--resturant-item" onclick="location.href='{{route('admin.restaurant.view', $item->id)}}'">
                <img onerror="this.src='{{asset('assets/admin/img/100x100/1.png')}}'" src="{{asset('storage/app/restaurant')}}/{{$item['logo']}}">
