                    ...
                    <div class="row gy-3">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="input-label" for="feature_title">{{ translate('messages.feature_title') }}
                                    <span data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('max_20_characters') }}"
                                    class="input-label-secondary"><img
                                        src="{{ asset('/assets/admin/img/info-circle.svg') }}"
                                        alt="{{ translate('max_20_characters') }}"></span>

                                </label>
                                <input type="text" id="feature_title" name="feature_title"  required class="form-control h--45px" maxlength="20"
                                    placeholder="{{ translate('Ex: Feature title') }}">
                            </div>
                            <div class="form-group mb-0">
                                <label class="input-label"
                                    for="feature_description">{{ translate('messages.feature_description') }}
                                </label>
                                <textarea placeholder="{{ translate('Ex: Feature description') }}" required name="feature_description" class="form-control" cols="30"
                                    rows="10"></textarea>
                            </div>
                        </div>
                        <div class="col-lg-6">
                                        ...
                                        <td>
                                            <div class="media align-items-center">
                                                <img class="avatar avatar-lg mr-3"
                                                    src="{{asset("storage/app/react_landing/feature/{$feature_item['img']}") }}"
