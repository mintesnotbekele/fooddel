                    ...
                    <div class="row gy-3">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="input-label" for="feature_title">{{ translate('messages.Banner Title') }}
                                ...
                                <input type="text" id="feature_title"   maxlength="20" name="title" class="form-control h--45px"
                                    placeholder="{{ translate('Ex: Feature title') }}">
                            </div>
                            <div class="form-group mb-0">
                                <label class="input-label"
                                    for="feature_description">{{ translate('messages.Banner Sub Title') }}
                                    ...
                                    <input type="text" id="feature_description"  maxlength="30" name="sub_title" class="form-control h--45px"
                                    placeholder="{{ translate('Ex: Feature title') }}">
                            </div>
                        </div>
                        <div class="col-lg-6">
                                        ...
                                        <td>
                                            <div class="media align-items-center">
                                                <img class="avatar avatar-lg mr-3"
                                                    src="{{asset("storage/app/react_landing/{$feature_item['img']}") }}"
