                ...
                <div class="row gy-3">
                                ...
                                <label class="d-block">
                                    ...
                                    <center id="image-viewer-section3">
                                        <img class="initial-7" id="viewer3"
                                            src="{{ asset('storage/app/react_landing/') }}/{{ isset($react_header_banner) ? $react_header_banner : 'react_header_banner.png' }}"
                                ...
                                <label class="d-block">
                                    ...
                                    <center id="image-viewer-section6">
                                        <img class="initial-7" id="viewer6"
                                            src="{{ asset('storage/app/react_landing/') }}/{{isset($app_section_image['app_section_image'])?$app_section_image['app_section_image']:'app_section_image.png'}}"
                                            onerror="this.src='{{ asset('assets/admin/img/160x160/img2.png') }}'"
                                            alt="" />
                                    </center>
                                </label>
                    ...
                    {{-- <div class="col-sm-6 col-xl-4">
                        <form action="{{ route('admin.business-settings.landing-page-settings', 'app_section_image') }}"
                            ...
                            <div class="form-group">
                                <span
                                    class="input-label text-center mb-3 d-block">{{ translate('App Section Image_small') }} <small
                                        class="text-danger">*
                                        ( {{translate('messages.size')}}: 1241 X 1755 px )
                                    </small></span>
                                <label class="d-block">
                                    ...
                                    <center id="image-viewer-section6">
                                        <img class="initial-7" id="viewer8"
                                            src="{{ asset('storage/app/react_landing') }}/{{isset($app_section_image['app_section_image_2'])?$app_section_image['app_section_image_2']:'app_section_image.png'}}"
                                            onerror="this.src='{{ asset('assets/admin/img/160x160/img2.png') }}'"
                                            alt="" />
                                    </center>
                                </label>
                                ...
                                <label class="d-block">
                                    ...
                                    <center id="image-viewer-section7">
                                        <img class="initial-7" id="viewer7"
                                            src="{{ asset('storage/app/react_landing') }}/{{ isset($footer_logo) ? $footer_logo : 'footer_logo.png' }}"
                                            onerror="this.src='{{ asset('assets/admin/img/160x160/img2.png') }}'"
                                            alt="" />
                                    </center>
                                </label>
                                            ...
                                            class="input-label text-center d-block mt-auto mb-lg-0">{{ translate('Full Banner Image') }}<small
                                                ...
                                                <center id="image-viewer-section" class="pt-2 mt-auto mb-auto">
                                                    <img class="initial-5" id="viewer"
                                                        src="{{ asset('storage/app/react_landing') }}/{{ $full_banner_section['banner_section_img_full'] ?? null }}"
                                                        onerror="this.src='{{ asset('assets/admin/img/160x160/img2.png') }}'"
                                                        alt="" />
                                                </center>
                                            ...
                                            class="input-label text-center d-block mt-auto mb-lg-0">{{ translate('Discount Banner Image') }}<small
                                                ...
                                                <center id="image-viewer-section2" class="pt-2 mt-auto mb-auto">
                                                    <img class="initial-5" id="viewer2"
                                                        src="{{ asset('storage/app/react_landing') }}/{{ $discount_section['img'] ?? null }}"
                                                        onerror="this.src='{{ asset('assets/admin/img/160x160/img2.png') }}'"
                                                        alt="" />
                                                </center>
