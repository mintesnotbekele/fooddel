                            ...
                            <div class="card-body">
                                <div class="payment--gateway-img">
                                    <img style="height: 80px"
                                         src="{{asset('storage/app/payment_modules/gateway_image')}}/{{$additional_data != null ? $additional_data->gateway_image : ''}}"
                                         onerror="this.src='{{asset('/assets/admin/img/blank3.png')}}'"
                                         alt="public">
                                </div>
    ...
    <div class="modal fade" id="digital-payment-modal">
        <div class="modal-dialog status-warning-modal">
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <div class="text-center mb-20">
                        <img src="{{asset('/assets/admin/img/modal/digital-payment-off.png')}}" alt="" class="mb-20">
                        ...
                        <!-- <img src="{{asset('/assets/admin/img/modal/digital-payment-on.png')}}" alt="" class="mb-20">
