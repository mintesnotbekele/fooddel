                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <label
                                            ...
                                            <input type="checkbox" onclick="toogleModal(event,'cash_in_hand_overflow','show-earning-in-apps-on.png','show-earning-in-apps-off.png','{{translate('Want_to_enable')}} <strong>{{translate('Cash_In_Hand_Overflow')}}</strong> ?','{{translate('Want_to_disable')}} <strong>{{translate('Cash_In_Hand_Overflow')}}</strong>  ?',`<p>{{translate('If_enabled,_restaurants_have_to_provide_collected_cash_by_them_self')}}</p>`,`<p>{{translate('If_disabled,_restaurants_do_not_have_to_provide_collected_cash_by_them_self')}}</p>`)" class="toggle-switch-input" value="1"
