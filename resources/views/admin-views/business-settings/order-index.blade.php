                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="form-group mb-0">
                                                <label
                                                    ...
                                                    <input type="checkbox" onclick="toogleModal(event,'instant_order','veg-on.png','veg-off.png','{{translate('Want_to_enable')}} <strong>{{translate('instant_order')}}</strong> ?','{{translate('Want_to_disable')}} <strong>{{translate('instant_order')}}</strong> ?',`<p>{{translate('If_enabled,_customers_can_order_instantly.')}}</p>`,`<p>{{translate('If_disabled,_customers_can_not_order_instantly.')}}</p>`)" class="toggle-switch-input" value="1"
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="form-group mb-0">
                                                <label
                                                    ...
                                                    <input type="checkbox" onclick="toogleModal(event,'customer_date_order_sratus','schedule-on.png','schedule-off.png','{{translate('Want_to_enable')}} <strong>{{translate('customer_date_order_sratus')}}</strong> ?','{{translate('Want_to_disable')}} <strong>{{translate('customer_date_order_sratus')}}</strong> ?',`<p>{{translate('If_enabled,_customers_can_not_select_schedule_date_over_the_given_days.')}}</p>`,`<p>{{translate('If_disabled,_customers_can_select_any_schedule_date.')}}</p>`)" class="toggle-switch-input" value="1"
