                                            ...
                                            <div class="form-group">
                                                <div class="d-flex flex-wrap justify-content-between mb-3">
                                                    ...
                                                    <input type="checkbox" name="offline_order_accept_message_status"
                                                        class="toggle-switch-input"
                                                        value="1"
                                                        onclick="toogleModal(event,'offline_order_accept_message','pending-order-on.png','pending-order-off.png','{{translate('By_Turning_ON')}} <strong>{{translate('Offline_Order_Accept_Message')}}</strong>','{{translate('By_Turning_OFF')}} <strong>{{translate('Offline_Order_Accept_Message')}}</strong>',`<p>{{translate('User_will_get_a_clear_message_to_know_that_orders_has_been_accepted')}}</p>`,`<p>{{translate('User_can_not_get_a_clear_message_to_know_that_orders_has_been_accepted_or_not')}}</p>`)"
                                            ...
                                            <div class="form-group">
                                                <div class="d-flex flex-wrap justify-content-between mb-3">
                                                    ...
                                                    <input type="checkbox" name="offline_order_deny_message_status"
                                                        class="toggle-switch-input"
                                                        value="1"
                                                        onclick="toogleModal(event,'offline_order_deny_message','pending-order-on.png','pending-order-off.png','{{translate('By_Turning_ON')}} <strong>{{translate('Offline_Order_Deny_Message')}}</strong>','{{translate('By_Turning_OFF')}} <strong>{{translate('Offline_Order_Deny_Message')}}</strong>',`<p>{{translate('User_will_get_a_clear_message_to_know_that_Offline_Order_payment_request_denied')}}</p>`,`<p>{{translate('User_can_not_get_a_clear_message_to_know_that_Offline_Order_payment_request_denied_or_not')}}</p>`)"
