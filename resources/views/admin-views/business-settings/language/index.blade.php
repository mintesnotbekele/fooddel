                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox{{$data['id']}}">
                                            <input type="checkbox"
                                            {{ (array_key_exists('default', $data) && $data['default']==true) ? 'disabled': ' ' }}
                                            onclick="updateStatus('{{route('admin.language.update-status')}}','{{$data['code']}}')" class="toggle-switch-input" id="stocksCheckbox{{$data['id']}}" {{$data['status']==1?'checked':''}}>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="defaultCheck{{$data['id']}}">
                                            <input type="checkbox" onclick="window.location.href ='{{route('admin.language.update-default-status', ['code'=>$data['code']])}}'" class="toggle-switch-input" id="defaultCheck{{$data['id']}}" {{ ((array_key_exists('default', $data) && $data['default']==true) ? 'checked': ((array_key_exists('default', $data) && $data['default']==false) ? '' : 'disabled')) }}>
                                            <span class="toggle-switch-label mx-auto">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
        ...
        <div class="modal fade" id="lang-modal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{route('admin.language.add-new')}}" method="post"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="direction">
                                            <option value="ltr">{{translate('messages.LTR')}}</option>
                                            <option value="rtl"> {{translate('messages.RTL')}}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
@push('script_2')
    ...
    <script>
            ...
            $(".delete").click(function (e) {
                ...
                Swal.fire({
                    title: '{{translate('Want to delete this language')}} ?',
                    text: "{{translate('If_yes,_the_language_will_be_removed_from_the_system_and_you_can’t_revert_it')}} !",
