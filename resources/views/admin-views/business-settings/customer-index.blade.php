            ...
            <div class="d-flex flex-wrap justify-content-between align-items-start">
                <h1 class="page-header-title mr-3">
                    <span class="page-header-icon">
                        <img src="{{ asset('assets/admin/img/business.png') }}" class="w--20" alt="">
                    </span>
                    <span>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            onclick="toogleModal(event,'ref_earning_status','referral-on.png','referral-off.png','{{translate('Want_to_enable_the')}} <strong>{{translate('Referral_Earning')}}</strong> ?','{{translate('Want_to_disable_the')}} <strong>{{translate('Referral_Earning')}}</strong> ?',`<p>{{translate('If_enabled,_Customers_can_earn_points_by_referring_others_to_sign_up_&_first_purchase_successfully_from_your_business.')}}</p>`,`<p>{{translate('If_disabled,_the_referral-earning_feature_will_be_hidden_from_the_Customer_App_&_Website.')}}</p>`)"
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-0">
                                        <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border  rounded px-4 form-control">
                                            ...
                                            <input type="checkbox" onclick="toogleModal(event,'customer_verification_status','customer-verification-on.png','customer-verification-off.png','{{translate('Want_to_enable_the')}} <strong>{{translate('Customer_Verification')}}</strong> ?','{{translate('Want_to_disable_the')}} <strong>{{translate('Customer_Verification')}}</strong> ?',`<p>{{translate('If_enabled,_Customers_must_verify_their_account_via_OTP.')}}</p>`,`<p>{{translate('If_disabled,_Customers_don’t_need_to_verify_their_account_via_OTP.')}}</p>`)" name="customer_verification"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            <input type="checkbox" class="toggle-switch-input"
                                            onclick="toogleModal(event,'customer_loyalty_point','loyalty-on.png','loyalty-off.png','{{translate('Want_to_enable_the')}} <strong>{{translate('Loyalty_Point')}}</strong> ?','{{translate('Want_to_disable_the')}} <strong>{{translate('Loyalty_Point')}}</strong> ?',`<p>{{translate('Customer_will_see_loyalty_point_option_in_his_profile_settings_&_can_earn_&_convert_this_point_to_wallet_money')}}</p>`,`<p>{{translate('Customer_will_no_see_loyalty_point_option_from_his_profile_settings')}}</p>`)"
