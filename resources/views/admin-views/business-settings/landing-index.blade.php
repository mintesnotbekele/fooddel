                ...
                <div class="card-body">
                    <label class="text-capitalize form-label form--label mb-3">
                            ...
                            <div class="__input-tab {{ $landing_integration_type == 'none' ?'active':'' }}" id="none">
                                <div class="__bg-F8F9FC-card">
                                    ...
                                    <div class="text-center max-w-595 mx-auto py-4">
                                        <img src="{{asset('/assets/admin/img/landing-icon-2.png')}}" class="mb-3" alt="">
                                        <p class="m-0">
                        ...
                        <div class="btn--container justify-content-end mt-3">
                            ...
                            <button type="button" onclick="zip_upload()" class="btn btn--primary mb-2" id="update_setting"> {{ translate('Save_Information') }}</button>
                        </div>
                    </div>
                </div>
            </form>
                        ...
                        <div class="item">
                            <div class="mb-20">
                                <div class="text-center">
                                    <img src="{{asset('/assets/admin/img/read-instructions.png')}}" alt="" class="mb-20">
