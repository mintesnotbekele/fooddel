                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_Admin_approves_an_offline_payment,_the_user_will_get_an_automatic_disapproval_mail_from_the_system.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input" onclick="toogleStatusModal(event,'mail-status','place-order-on.png','place-order-off.png','{{translate('Want_to_enable_offline_payment_approve_mail?')}}','{{translate('Want_to_disable_offline_payment_approve_mail?')}}',`<p>{{translate('If_enabled,_User_will_receive_a_confirmation_email_when_the_Admin_approves_their_offline_payment.')}}</p>`,`<p>{{translate('If_disabled,_Users_will_not_get_offline_payment_approve_mail.')}}</p>`)" id="mail-status" {{$mail_status == '1'?'checked':''}}>
