...
<table style="width:100%;max-width:500px;margin:0 auto;text-align:center;background:#fff">
    ...
    <tr>
        <td style="padding:30px 30px 0">
            ...
            src="{{ asset('storage/app/email_template/') }}/{{ $data['icon']??'' }}" id="iconViewer" alt="">
    ...
    <tr>
        <td style="padding:0 30px 30px; text-align:left">
            ...
            <img style="width:120px;display:block;margin:10px auto" onerror="this.src='{{asset('/assets/admin/img/favicon.png')}}'" src="{{ asset('storage/app/business/' . $logo) }}" alt="img">
        </td>
    </tr>
    <tr>
