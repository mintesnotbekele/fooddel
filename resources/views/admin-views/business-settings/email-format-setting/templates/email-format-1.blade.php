    ...
    <tbody>
        ...
        <tr>
            <td class="main-table-td">
                <img class="mail-img-1" onerror="this.src='{{ asset('/assets/admin/img/blank1.png') }}'"
                src="{{ asset('storage/app/email_template/') }}/{{ $data['logo']??'' }}" id="logoViewer" alt="">
                ...
                src="{{ asset('storage/app/email_template/') }}/{{ $data['image']??'' }}" alt="">
