            ...
            <div class="search--button-wrapper">
                ...
                <form id="search-form">
                    <div class="input--group input-group input-group-merge input-group-flush">
                        <input id="datatableSearch" type="search" name="search" class="form-control" placeholder="{{ translate('messages.Ex:_Search_by_name_or_email')}}" aria-label="Search contacts">
                    ...
                    <tbody id="set-rows">
                        ...
                        <td style="width: 8%">
                            ...
                            <a class="btn btn-sm btn--danger btn-outline-danger action-btn"   href="javascript:"
                                        onclick="form_alert('contact-{{$contact['id']}}','{{ translate('messages.Want_to_delete_this_contact_message_?') }}')" title="{{translate('messages.delete_contact')}}"><i class="tio-delete-outlined"></i></a>
