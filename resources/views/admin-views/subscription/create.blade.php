    ...
    <div class="content container-fluid">
        ...
        <div class="page-header pb-0">
            <div class="d-flex flex-wrap justify-content-between align-items-start">
                ...
                <img src="{{ asset('/assets/admin/img/subscription-plan.png') }}" alt="" class="w-24 mr-2">
                    <div>
        ...
        <form action="{{ route('admin.subscription.subscription_store') }}" method="post">
                ...
                <div class="card-header">
                    <h5 class="card-title d-flex align-items-center font-medium">
                        <span class="card-header-icon mr-1">
                            <img src="{{ asset('/assets/admin/img/bill.svg') }}"
                                alt="">
                        </span>
                        <span>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h5 class="card-title d-flex align-items-center font-medium">
                        <span class="card-header-icon mr-1">
                            <img src="{{ asset('/assets/admin/img/package.png') }}" alt="">
                        </span>
                        <span>
