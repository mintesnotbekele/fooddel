        ...
        <div class="change-plan-wrapper align-items-center">
            <div class="plan-item">
                <div class="plan-header">
                    <img class="plan-header-shape" src="{{ asset('/assets/admin/img/plan-1.svg') }}" alt="">
            ...
            <div class="plan-seperator-arrow mx-auto">
                <img src="{{ asset('/assets/admin/img/arrow.svg') }}" alt="" class="w-100">
            </div>
            <!-- Plan Seperator Arrow -->
            ...
            <div class="plan-item">
                <div class="plan-header">
                    ...
                    <img class="plan-header-shape" src="{{ asset('/assets/admin/img/plan-2.svg') }}" alt="">
