    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <img src="{{asset('/assets/admin/img/bill.png')}}" alt="" class="w-24 mr-2">
        ...
        {{-- <div class="row g-3 mb-3">
            <div class="col-xl-3 col-sm-6">
                <div class="resturant-card bg--1">
                    ...
                    <img class="resturant-icon w-35x" src="{{asset('/assets/admin/img/subscription-list/1.svg')}}" alt="resturant">
                </div>
            </div>
            <div class="col-xl-3 col-sm-6">
                <div class="resturant-card bg--2">
                    ...
                    <img class="resturant-icon w-35x" src="{{asset('/assets/admin/img/subscription-list/2.svg')}}" alt="resturant">
                </div>
            </div>
            <div class="col-xl-3 col-sm-6">
                <div class="resturant-card bg--4">
                    ...
                    <img class="resturant-icon w-35x" src="{{asset('/assets/admin/img/subscription-list/3.svg')}}" alt="resturant">
                </div>
            </div>
            <div class="col-xl-3 col-sm-6">
                <div class="resturant-card bg--3">
                    ...
                    <img class="resturant-icon w-35x" src="{{asset('/assets/admin/img/subscription-list/4.svg')}}" alt="resturant">
                </div>
            </div>
        </div> --}}
        <!--  -->
