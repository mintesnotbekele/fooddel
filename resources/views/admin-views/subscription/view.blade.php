    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <img src="{{asset('/assets/admin/img/entypo_shop.png')}}" class="page-header-icon w-20px mr-1" alt="">
                ...
                <div id="all_data" class="row g-3 mb-3 desc">
                    <div class="col-xl-3 col-sm-6">
                        <div class="resturant-card bg--1">
                            ...
                            <img class="resturant-icon" src="{{asset('/assets/admin/img/subscription-list/1.svg')}}" alt="resturant">
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="resturant-card bg--2">
                            ...
                            <img class="resturant-icon" src="{{asset('/assets/admin/img/subscription-list/2.svg')}}" alt="resturant">
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="resturant-card bg--3">
                            ...
                            <img class="resturant-icon" src="{{asset('/assets/admin/img/subscription-list/3.svg')}}" alt="resturant">
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6">
                        <div class="resturant-card bg--4">
                            ...
                            <img class="resturant-icon" src="{{asset('/assets/admin/img/subscription-list/4.svg')}}" alt="resturant">
                        </div>
                    </div>
                        ...
                        <a class="order--card h-100" href="#0">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                    <img src="{{asset('/assets/admin/img/report/2.svg')}}" alt="dashboard" class="oder--card-icon w-20px">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <a class="order--card h-100" href="#0">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                    <img src="{{asset('/assets/admin/img/report/4.svg')}}" alt="dashboard" class="oder--card-icon w-20px">
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <a class="order--card h-100" href="#0">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                    <img src="{{asset('/assets/admin/img/report/1.svg')}}" alt="dashboard" class="oder--card-icon w-20px">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <a class="order--card h-100" href="#0">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                    <img src="{{asset('/assets/admin/img/report/3.svg')}}" alt="dashboard" class="oder--card-icon w-20px">
            ...
            <div class="card-header border-0 align-items-center">
                ...
                <div class="d-flex align-items-center justify-content-center">
                    <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox{{$package->id}}"> {{ translate('messages.Status') }}:&nbsp;
                        ...
                        '{{$package->status?translate('Do_You_Want_To_Disable_This_Package'):translate('Do_you_want_to_Active_This_Package')}}', event)"
