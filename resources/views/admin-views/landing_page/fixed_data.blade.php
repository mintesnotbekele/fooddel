                ...
                <div class="card-body">
                    <div class="row g-3 lang_form default-form" id="default-form">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" maxlength="30"  name="title[]" value="{{ $news_letter_title?->getRawOriginal('value') ?? null}}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                    ...
                    <div class="row g-3 d-none lang_form" id="{{$lang}}-form">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="title[]"   maxlength="30" value="{{ $news_letter_title_translate[$lang]['value'] ?? '' }}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                        </div>
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="sub_title[]" maxlength="70" value="{{ $news_letter_sub_title_translate[$lang]['value'] ?? '' }}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                        </div>
                    </div>
                    @empty
                    @endforelse
