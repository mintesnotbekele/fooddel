    ...
    <div class="d-flex justify-content-between __gap-12px mb-3">
        <h5 class="card-title d-flex align-items-center">
            <span class="card-header-icon mr-2">
                <img src="{{asset('assets/admin/img/react_header.png')}}" alt="" class="mw-100">
            </span>
        ...
        <div class="card-body">
            <div class="row g-3 lang_form default-form" id="default-form">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" maxlength="20" name="services_title[]" value="{{ $services_title?->getRawOriginal('value') ?? null}}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                </div>
                <div class="col-sm-6">
                    ...
                    <input type="text" maxlength="70" name="services_sub_title[]" value="{{ $services_sub_title?->getRawOriginal('value') ?? null}}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                </div>
            </div>
            ...
            <div class="row g-3 d-none lang_form" id="{{$lang}}-form">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" maxlength="20" name="services_title[]" value="{{ $services_title_translate[$lang]['value'] ?? '' }}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                </div>
                <div class="col-sm-6">
                    ...
                    <input type="text" maxlength="70" name="services_sub_title[]" value="{{ $services_sub_title_translate[$lang]['value'] ?? '' }}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                </div>
            </div>
            @empty
            @endforelse
            ...
            <div class="lang_form default-form">
                ...
                <div class="row g-3">
                    <div class="col-sm-6">
                        ...
                        <input type="text" maxlength="20" class="form-control" placeholder="{{translate('Enter_Title')}}" name="services_order_title_1[]" value="{{ $services_order_title_1?->getRawOriginal('value') ?? '' }}">
                    </div>
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" placeholder="{{translate('Enter_Title')}}" maxlength="20" name="services_order_title_2[]" value="{{ $services_order_title_2?->getRawOriginal('value') ?? '' }}">
                    </div>
                    <div class="col-sm-6">
                        <label class="form-label">{{translate('Short_Description_1')}}
                    ...
                    <div class="col-sm-6">
                        <label class="form-label">{{translate('Short_Description_2')}}
                    ...
                    <div class="col-md-6">
                        <div class="__bg-F8F9FC-card">
                            <div class="form-group mb-md-0">
                                ...
                                <input type="text" maxlength="15" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="services_order_button_name[]" value="{{ $services_order_button_name?->getRawOriginal('value')  ?? null }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="d-none lang_form" id="{{$lang}}-form1">
                <div class="row g-3">
                    <div class="col-sm-6">
                        ...
                        <input type="text" maxlength="20" class="form-control" placeholder="{{translate('Enter_Title')}}" name="services_order_title_1[]" value="{{ $services_order_title_1_translate[$lang]['value'] ?? '' }}">
                    </div>
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" placeholder="{{translate('Enter_Title')}}" maxlength="20" name="services_order_title_2[]" value="{{ $services_order_title_2_translate[$lang]['value'] ?? '' }}">
                    </div>
                    <div class="col-sm-6">
                        <label class="form-label">{{translate('Short_Description_1')}} ({{strtoupper($lang)}})
                            <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Write_the_short_description_within_120_characters') }}">
                                <i class="tio-info-outined"></i>
                            </span>
                        </label>
                    ...
                    <div class="col-sm-6">
                        <label class="form-label">{{translate('Short_Description_2')}} ({{strtoupper($lang)}})
                            <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Write_the_short_description_within_120_characters') }}">
                                <i class="tio-info-outined"></i>
                            </span>
                        </label>
                    ...
                    <div class="col-md-6">
                        <div class="__bg-F8F9FC-card">
                            <div class="form-group mb-md-0">
                                ...
                                <input type="text" maxlength="15" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="services_order_button_name[]" value="{{ $services_order_button_name_translate[$lang]['value'] ?? null }}">
                            </div>
                        </div>
                    </div>
            ...
            <div class="lang_form default-form">
                ...
                <div class="row g-3">
                    <div class="col-sm-6">
                        ...
                        <input type="text" maxlength="20" class="form-control" placeholder="{{translate('Enter_Title')}}" name="services_manage_restaurant_title_1[]" value="{{ $services_manage_restaurant_title_1?->getRawOriginal('value')  ?? '' }}">
                    </div>
                    <div class="col-sm-6">
                        <label class="form-label">{{translate('Title_2')}}
                            <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Write_the_title_within_20_characters') }}">
                        ...
                        <input type="text" maxlength="20" class="form-control" placeholder="{{translate('Enter_Title')}}" name="services_manage_restaurant_title_2[]" value="{{ $services_manage_restaurant_title_2?->getRawOriginal('value')  ?? '' }}">
                    </div>
                    <div class="col-sm-6">
                        <label class="form-label">{{translate('Short_Description_1')}}
                            <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Write_the_short_description_within_120_characters') }}">
                    ...
                    <div class="col-md-6">
                        <div class="__bg-F8F9FC-card">
                            <div class="form-group mb-md-0">
                                ...
                                <input type="text" maxlength="15" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="services_manage_restaurant_button_name[]" value="{{ $services_manage_restaurant_button_name?->getRawOriginal('value')  ?? null }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="d-none lang_form" id="{{$lang}}-form2">
                <div class="row g-3">
                    <div class="col-sm-6">
                        ...
                        <input type="text" maxlength="20" class="form-control" placeholder="{{translate('Enter_Title')}}" name="services_manage_restaurant_title_1[]" value="{{ $services_manage_restaurant_title_1_translate[$lang]['value'] ?? '' }}">
                    </div>
                    <div class="col-sm-6">
                        <label class="form-label">{{translate('Title_2')}} ({{strtoupper($lang)}})
                            <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Write_the_title_within_20_characters') }}">
                        ...
                        <input type="text" maxlength="20" class="form-control" placeholder="{{translate('Enter_Title')}}" name="services_manage_restaurant_title_2[]" value="{{ $services_manage_restaurant_title_2_translate[$lang]['value'] ?? '' }}">
                    </div>
                    <div class="col-sm-6">
                        <label class="form-label">{{translate('Short_Description_1')}} ({{strtoupper($lang)}})
                            <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Write_the_short_description_within_120_characters') }}">
                    ...
                    <div class="col-md-6">
                        <div class="__bg-F8F9FC-card">
                            <div class="form-group mb-md-0">
                                ...
                                <input type="text" maxlength="15" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="services_manage_restaurant_button_name[]" value="{{ $services_manage_restaurant_button_name_translate[$lang]['value'] ?? null }}">
                            </div>
                        </div>
                    </div>
            ...
            <div class="lang_form default-form">
                ...
                <div class="row g-3">
                    <div class="col-sm-6">
                        ...
                        <input type="text" maxlength="20" class="form-control" placeholder="{{translate('Enter_Title')}}" name="services_manage_delivery_title_1[]" value="{{ $services_manage_delivery_title_1?->getRawOriginal('value')  ?? '' }}">
                    </div>
                    <div class="col-sm-6">
                        <label class="form-label">{{translate('Title_2')}}
                            <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Write_the_title_within_20_characters') }}">
                        ...
                        <input type="text" maxlength="20" class="form-control" placeholder="{{translate('Enter_Title')}}" name="services_manage_delivery_title_2[]" value="{{ $services_manage_delivery_title_2?->getRawOriginal('value')  ?? '' }}">
                    </div>
                    <div class="col-sm-6">
                        <label class="form-label">{{translate('Short_Description_1')}}
                    ...
                    <div class="col-md-6">
                        <div class="__bg-F8F9FC-card">
                            <div class="form-group mb-md-0">
                                ...
                                <input type="text" maxlength="15" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="services_manage_delivery_button_name[]" value="{{ $services_manage_delivery_button_name?->getRawOriginal('value')  ?? null }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="d-none lang_form" id="{{$lang}}-form3">
                <div class="row g-3">
                    <div class="col-sm-6">
                        ...
                        <input type="text" maxlength="20" class="form-control" placeholder="{{translate('Enter_Title')}}" name="services_manage_delivery_title_1[]" value="{{ $services_manage_delivery_title_1_translate[$lang]['value'] ?? '' }}">
                    </div>
                    <div class="col-sm-6">
                        <label class="form-label">{{translate('Title_2')}} ({{strtoupper($lang)}})
                            <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Write_the_title_within_20_characters') }}">
                        ...
                        <input type="text" maxlength="20" class="form-control" placeholder="{{translate('Enter_Title')}}" name="services_manage_delivery_title_2[]" value="{{ $services_manage_delivery_title_2_translate[$lang]['value'] ?? '' }}">
                    </div>
                    <div class="col-sm-6">
                        <label class="form-label">{{translate('Short_Description_1')}} ({{strtoupper($lang)}})
                            <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Write_the_short_description_within_120_characters') }}">
                    ...
                    <div class="col-md-6">
                        <div class="__bg-F8F9FC-card">
                            <div class="form-group mb-md-0">
                                ...
                                <input type="text" maxlength="15" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="services_manage_delivery_button_name[]" value="{{ $services_manage_delivery_button_name_translate[$lang]['value'] ?? null }}">
                            </div>
                        </div>
                    </div>
