                            ...
                            <div class="col-md-6">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name" maxlength="191" required  value="{{ $review->name }}" class="form-control" placeholder="{{translate('Ex:_John')}}">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">{{translate('Designation')}}</label>
                                        <input type="text"  maxlength="191" required name="designation" value="{{ $review->designation }}" class="form-control" placeholder="{{translate('Ex:_CTO')}}">
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="review"  maxlength="300" required  placeholder="{{translate('Very_Good_Company')}}" class="form-control h92px">{{ $review->review }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex gap-40px">
                                    <div>
                                        ...
                                        <label class="upload-img-3 m-0 d-block">
                                            <div class="img">
                                                <img src="{{asset('storage/app/reviewer_image')}}/{{$review->reviewer_image}}"onerror="this.src='{{asset("/assets/admin/img/aspect-1.png")}}'" class="vertical-img max-w-187px" alt="">
                                            </div>
                                    ...
                                    {{-- <div class="d-flex flex-column">
                                        ...
                                        <label class="upload-img-3 m-0 d-block my-auto">
                                            <div class="img">
                                                <img src="{{asset('storage/app/reviewer_image')}}/{{$review->company_image}}" onerror="this.src='{{asset("/assets/admin/img/aspect-3-1.png")}}'" class="vertical-img max-w-187px" alt="">
                                            </div>
