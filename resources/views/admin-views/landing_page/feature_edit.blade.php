                            ...
                            <div class="col-md-6 lang_form" id="default-form">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="name[]" maxlength="20"     value="{{ $feature?->getRawOriginal('title') }}" class="form-control" placeholder="{{translate('Ex:_John')}}">
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="description[]" maxlength="60" placeholder="{{translate('Very_Good_Company')}}" class="form-control h92px">{{ $feature?->getRawOriginal('description') }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    <label class="form-label">{{translate('messages.Short_Description')}} ({{strtoupper($lang)}})
                                      <span class="input-label-secondary text--title"  data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Write_the_short_description_within_60_characters') }}">
                                        ...
                                        <textarea name="description[]" maxlength="60" placeholder="{{translate('Very_Good_Company')}}" class="form-control h92px">{{ $translate[$lang]['feature_description']??'' }}</textarea>
                                    </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex gap-40px">
                                    <div>
                                        ...
                                        <label class="upload-img-3 m-0 d-block">
                                            <div class="img">
                                                <img src="{{asset('storage/app/feature_image')}}/{{$feature->image}}" onerror="this.src='{{asset("/assets/admin/img/aspect-1.png")}}'" class="vertical-img max-w-187px" alt="">
                                            </div>
