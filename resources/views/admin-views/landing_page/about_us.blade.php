                            ...
                            <div class="row g-4" >
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <label class="form-label">{{translate('messages.Short_Description')}}
                                        ...
                                        <textarea  maxlength="160" class="form-control" name="about_us_text[]" placeholder="{{translate('messages.Short_Description')}}">{{ $header_tag_line?->getRawOriginal('value') ?? null}}</textarea>
                                    </div>
                            </div>
                                ...
                                <div class="d-none lang_form" id="{{$lang}}-form">
                                    ...
                                    <div class="row g-4" >
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <textarea class="form-control" maxlength="160" name="about_us_text[]" placeholder="{{translate('messages.Short_Description')}}">{{$header_tag_line_translate[$lang]['value']??''}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="__bg-F8F9FC-card">
                                        ...
                                        <div class="lang_form default-form">
                                            <div class="form-group mb-md-0">
                                                ...
                                                <input type="text" maxlength="15"  value="{{  $about_us_app_button_name?->getRawOriginal('value') ?? null }}" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="about_us_app_button_name[]" >
                                            </div>
                                        </div>
                                            ...
                                            @foreach(json_decode($language) as $lang)
                                                ...
                                                <div class="d-none lang_form" id="{{$lang}}-form1">
                                                    <div class="form-group mb-md-0">
                                                        ...
                                                        <input type="text" maxlength="15"  value="{{$about_us_app_button_name_translate[$lang]['value']??''}}" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="about_us_app_button_name[]" >
                                                    </div>
                                                </div>
                                ...
                                <div class="position-relative">
                                    <label class="upload-img-3 m-0 d-block">
                                        <div class="img">
                                            ...
                                            <img src="{{asset('storage/app/about_us_image')}}/{{ $about_us_content_image ?? null }}" onerror="this.src='{{asset("/assets/admin/img/upload-6.png")}}'" class="vertical-img max-w-187px" alt="">
                                        </div>
