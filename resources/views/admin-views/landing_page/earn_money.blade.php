        ...
        <div class="card-body">
            <div class="row g-3 lang_form default-form" id="default-form">
                ...
                <div class="col-sm-6">
                    ...
                    <input maxlength="40" type="text" name="earn_money_title[]" value="{{ $earn_money_title?->getRawOriginal('value') ?? null}}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                </div>
                <div class="col-sm-6">
                    ...
                    <input maxlength="70" type="text" name="earn_money_sub_title[]" value="{{ $earn_money_sub_title?->getRawOriginal('value') ?? null}}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                </div>
            </div>
            @if($language)
            ...
            <div class="row g-3 d-none lang_form" id="{{$lang}}-form">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" maxlength="40" name="earn_money_title[]" value="{{ $earn_money_title_translate[$lang]['value'] ?? '' }}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                </div>
                <div class="col-sm-6">
                    ...
                    <input type="text" maxlength="70" name="earn_money_sub_title[]" value="{{ $earn_money_sub_title_translate[$lang]['value'] ?? '' }}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                </div>
            </div>
            @empty
            @endforelse
            ...
            <div class="row g-3 ">
                <div class="col-sm-6">
                    <div class="form-group lang_form default-form">
                        ...
                        <input type="text" maxlength="40" name="earn_money_reg_title[]" value="{{ $earn_money_reg_title?->getRawOriginal('value') ?? null }}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                    </div>
                    ...
                    <div class="form-group d-none lang_form" id="{{$lang}}-form1">
                        ...
                        <input type="text" maxlength="40" name="earn_money_reg_title[]" class="form-control" placeholder="{{translate('Enter_Title')}}" value="{{  $earn_money_reg_title_translate[$lang]['value'] ?? '' }}">
                    </div>
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="position-relative">
                                ...
                                <label class="upload-img-3 m-0 d-block my-auto">
                                    <div class="img">
                                        <img src="{{asset('storage/app/earn_money')}}/{{ $earn_money_reg_image?->getRawOriginal('value') ?? null }}" onerror="this.src='{{asset("/assets/admin/img/upload-3.png")}}'" class="img__aspect-unset mw-100 min-w-187px" alt="">
                                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group lang_form default-form">
                                    ...
                                    <input type="text" maxlength="15" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="earn_money_restaurant_req_button_name[]" value="{{ $earn_money_restaurant_req_button_name?->getRawOriginal('value') ?? '' }}">
                                </div>
                                ...
                                <div class="form-group d-none lang_form" id="{{$lang}}-form2">
                                    ...
                                    <input type="text" maxlength="15" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="earn_money_restaurant_req_button_name[]" value="{{ $earn_money_restaurant_req_button_name_translate[$lang]['value'] ?? '' }}">
                                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group lang_form default-form">
                                    ...
                                    <input type="text" maxlength="15" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="earn_money_delivety_man_req_button_name[]" value="{{  $earn_money_delivety_man_req_button_name->value ?? '' }}">
                                </div>
                                ...
                                <div class="form-group d-none lang_form" id="{{$lang}}-form3">
                                    ...
                                    <input type="text" maxlength="15" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="earn_money_delivety_man_req_button_name[]" value="{{  $earn_money_delivety_man_req_button_name_translate[$lang]['value']?? '' }}">
                                </div>
