                                ...
                                <div class="form-group mb-md-0">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <label class="toggle-switch toggle-switch-sm m-0">
                                            ...
                                            onclick="toogleModal(event,'button_status','play-store-on.png','play-store-off.png',' <strong>{{translate('By_Turning_ON_The_Button')}}</strong>','<strong>{{translate('By_Turning_OFF_The_Button')}}</strong>',`<p>{{translate('This_button_will_be_enabled_now_everyone_can_use_or_see_the_button')}}</p>`,`<p>{{translate('This_button_will_be_disabled_now_no_one_can_use_or_see_the_button')}}</p>`)" name="app_url_android_status"
                                            >
                                    ...
                                    <input type="text" value="{{isset($landing_page_links)?$landing_page_links['app_url_android']:''}}" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="app_url_android" >
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group mb-md-0">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <label class="toggle-switch toggle-switch-sm m-0">
                                            ...
                                            onclick="toogleModal(event,'app_url_ios_status','apple-on.png','apple-off.png',' <strong>{{translate('By_Turning_ON_The_Button')}}</strong>','<strong>{{translate('By_Turning_OFF_The_Button')}}</strong>',`<p>{{translate('This_button_will_be_enabled_now_everyone_can_use_or_see_the_button')}}</p>`,`<p>{{translate('This_button_will_be_disabled_now_no_one_can_use_or_see_the_button')}}</p>`)" name="app_url_ios_status"
                                            >
                                            <span class="toggle-switch-label text mb-0">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                    ...
                                    <input type="text" value="{{isset($landing_page_links)?$landing_page_links['app_url_ios']:''}}" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="app_url_ios" >
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group mb-md-0">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <label class="toggle-switch toggle-switch-sm m-0">
                                            ...
                                            onclick="toogleModal(event,'web_app_url_status','promotional-on.png','promotional-off.png',' <strong>{{translate('By_Turning_ON_The_Button')}}</strong>','<strong>{{translate('By_Turning_OFF_The_Button')}}</strong>',`<p>{{translate('This_button_will_be_enabled_now_everyone_can_use_or_see_the_button')}}</p>`,`<p>{{translate('This_button_will_be_disabled_now_no_one_can_use_or_see_the_button')}}</p>`)" name="web_app_url_status"
                                            >
                                            <span class="toggle-switch-label text mb-0">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                    ...
                                    <input type="text" value="{{isset($landing_page_links)?$landing_page_links['web_app_url']:''}}" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="web_app_url" >
                                </div>
                            </div>
                        </div>
