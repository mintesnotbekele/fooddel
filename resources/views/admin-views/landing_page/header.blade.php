                                    ...
                                    <div class="__bg-F8F9FC-card">
                                        <div class="lang_form default-form">
                                            <div class="form-group mb-md-0">
                                                ...
                                                <input type="text" maxlength="10" value="{{ $header_app_button_name?->getRawOriginal('value') ?? null }}" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="header_app_button_name[]" >
                                            </div>
                                        </div>
                                            ...
                                            @foreach(json_decode($language) as $lang)
                                                ...
                                                <div class="d-none lang_form" id="{{$lang}}-form1">
                                                    <div class="form-group mb-md-0">
                                                        ...
                                                        <input type="text" maxlength="10" value="{{$header_app_button_name_translate[$lang]['value']??''}}" placeholder="{{translate('Ex:_Order_now')}}" class="form-control h--45px" name="header_app_button_name[]" >
                                                    </div>
                                                </div>
                        ...
                        <div class="d-flex gap-40px">
                            <div>
                                <label class="form-label d-block mb-2">
                                    {{translate('Content_Image')}}  <span class="text--primary">(600x1700px)</span>
                                </label>
                                    <div class="position-relative">
                                        <label class="upload-img-3 m-0 d-block">
                                                <div class="img">
                                                    <img src="{{asset('storage/app/header_image')}}/{{ $image_content['header_content_image'] ?? null }}" onerror="this.src='{{asset("/assets/admin/img/upload-6.png")}}'" alt="" class="vertical-img max-w-187px">
                                                </div>
                            ...
                            <div class="d-flex flex-column">
                                <div>
                                    <label class="form-label d-block mb-2">
                                        {{translate('Section_Background_Image')}}  <span class="text--primary">(1600x1700px)</span>
                                    </label>
                                    <div class="position-relative d-inline-block">
                                        <label class="upload-img-3 m-0 d-block ">
                                            <div class="img">
                                                <img src="{{asset('storage/app/header_image')}}/{{ $image_content['header_bg_image'] ?? null }}" onerror="this.src='{{asset("/assets/admin/img/upload-6.png")}}'" class="vertical-img max-w-187px" alt="">
                                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-4">
                            <div class="col-sm-6 col-md-3">
                                ...
                                <label class="form-label">{{translate('Total_Order')}}
                                ...
                                <input type="number" min="0"  name="header_floating_total_order" value="{{ $header_floating_content['header_floating_total_order'] ?? null }}" class="form-control" placeholder="{{translate('messages.Ex:_34')}}">
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <label class="form-label">{{translate('Total_User')}}
                                ...
                                <input type="number" min="0"   name="header_floating_total_user"  value="{{ $header_floating_content['header_floating_total_user'] ?? null }}" class="form-control" placeholder="{{translate('messages.Ex:_34')}}">
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <label class="form-label">{{translate('Total_Reviews')}}
                                ...
                                <input type="number" min="0"  name="header_floating_total_reviews"  value="{{ $header_floating_content['header_floating_total_reviews'] ?? null }}"  class="form-control" placeholder="{{translate('messages.Ex:_34')}}">
                            </div>
                        </div>
                        <div class="btn--container justify-content-end mt-3">
                            <button type="reset" class="btn btn--reset">{{translate('Reset')}}</button>
