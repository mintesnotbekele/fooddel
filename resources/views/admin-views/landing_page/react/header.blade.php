                        ...
                        <div class="col-md-6 lang_form default-form">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input maxlength="20" type="text" name="react_header_title[]"  class="form-control" placeholder="{{translate('Ex:_John')}}"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input maxlength="50" type="text" name="react_header_sub_title[]"  placeholder="{{translate('Very_Good_Company')}}"  class="form-control"
                        ...
                        <div class="col-md-6 d-none lang_form" id="{{$lang}}-form1">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input maxlength="20" type="text" name="react_header_title[]" class="form-control" placeholder="{{translate('Ex:_John')}}" value="{{ $react_header_title_translate[$lang]['value'] ?? '' }}">
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" maxlength="50"  name="react_header_sub_title[]" placeholder="{{translate('Very_Good_Company')}}"  class="form-control"
                        ...
                        <div class="col-sm-6">
                            <div class="ml-xl-5 pl-xxl-4">
                                ...
                                <label class="upload-img-3 m-0 d-block">
                                    <div class="img">
                                        <img src="{{asset('storage/app/react_header')}}/{{$react_header_image?->value ?? ''}}" onerror='this.src="{{asset('/assets/admin/img/upload-3.png')}}"' class="vertical-img max-w-187px" alt="">
                                    </div>
