                    ...
                    <div class="row g-3">
                        <div class="col-md-6 lang_form default-form">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <textarea maxlength="50"  class="form-control h-84px" name="description[]" placeholder="{{translate('Enter_Your_Description')}}"></textarea>
                                </div>
                        </div>
                    ...
                    <table class="table table-borderless table-thead-bordered table-align-middle table-nowrap card-table ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{asset('storage/app/react_promotional_banner')}}/{{$react_promotional_banner->image}}"
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        ...
                                        onclick="form_alert_service('react_promotional_banner-{{$react_promotional_banner['id']}}','{{ translate('Want_to_Delete_this_Promotional_Banner') }}','{{ translate('If_yes,_the_banner_will_be_removed_from_this_list.') }}')" title="{{translate('messages.delete_react_promotional_banner')}}"><i class="tio-delete-outlined"></i>
                                        </a>
