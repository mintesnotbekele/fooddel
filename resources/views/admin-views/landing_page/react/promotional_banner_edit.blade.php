                            ...
                            <div class="col-md-6 lang_form" id="default-form">
                                <input type="hidden" name="lang[]" value="default">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="20" name="title[]"    value="{{ $react_promotional_banner?->getRawOriginal('title') }}" class="form-control" placeholder="{{translate('Ex:_John')}}">
                                    </div>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <textarea name="description[]" maxlength="50"  class="form-control h-84px" placeholder="{{translate('Very_Good_Company')}}" cols="30" rows="10"> {{ $react_promotional_banner?->getRawOriginal('description') }} </textarea>
                                    </div>
                            </div>
                        ...
                        <div class="col-md-6 d-none lang_form" id="{{$lang}}-form1">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <span class="input-label-secondary text--title" data-toggle="tooltip"
                                        ...
                                        <textarea name="description[]" maxlength="50"  class="form-control h-84px" placeholder="{{translate('Very_Good_Company')}}" cols="30" rows="10"> {{ $translate[$lang]['react_promotional_banner_description']??''}} </textarea>
                                    </div>
                            </div>
                                ...
                                <div class="d-flex gap-40px">
                                    <div>
                                        ...
                                        <label class="upload-img-3 m-0 d-block">
                                            <div class="img">
                                                <img src="{{asset('storage/app/react_promotional_banner')}}/{{$react_promotional_banner?->image}}" onerror="this.src='{{asset('/assets/admin/img/upload-3.png')}}'" class="vertical-img max-w-187px" alt="">
                                            </div>
