                            ...
                            <div class="col-md-6 lang_form" id="default-form">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" maxlength="20" name="title[]"   value="{{ $service?->getRawOriginal('title') }}" class="form-control" placeholder="{{translate('Ex:_John')}}">
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" maxlength="80" name="sub_title[]"  value="{{ $service?->getRawOriginal('sub_title') }}" class="form-control" placeholder="{{translate('Very_Good_Company')}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <label class="form-label">{{translate('Subtitle')}} ({{strtoupper($lang)}})
                                        ...
                                        <input type="text" maxlength="80" name="sub_title[]"  value="{{ $translate[$lang]['react_service_sub_title']??'' }}"  class="form-control" placeholder="{{translate('Very_Good_Company')}}">
                                    </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex gap-40px">
                                    <div>
                                        ...
                                        <label class="upload-img-3 m-0 d-block">
                                            <div class="img">
                                                <img src="{{asset('storage/app/react_service_image')}}/{{$service->image}}" onerror="this.src='{{asset("/assets/admin/img/aspect-1.png")}}'" class="vertical-img max-w-187px" alt="">
                                            </div>
