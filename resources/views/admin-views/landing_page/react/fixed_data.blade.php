    ...
    <div class="page-header">
        ...
        @endif
            <div class="d-flex justify-content-between __gap-12px mb-3">
                <h5 class="card-title d-flex align-items-center">
                    <span class="card-header-icon mr-2">
                        <img src="{{asset('assets/admin/img/fixed_data1.png')}}" alt="" class="mw-100">
                    </span>
                ...
                <div class="card-body">
                    <div class="row g-3 lang_form default-form" id="default-form">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input maxlength="30" type="text"  name="title[]" value="{{ $news_letter_title?->getRawOriginal('value') ?? null}}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input maxlength="70" type="text"  name="sub_title[]" value="{{ $news_letter_sub_title?->getRawOriginal('value') ?? null}}"  class="form-control" placeholder="{{translate('Enter_Sub_Title')}}">
                    ...
                    <div class="row g-3 d-none lang_form" id="{{$lang}}-form">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" maxlength="30" name="title[]" value="{{ $news_letter_title_translate[$lang]['value'] ?? '' }}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                        </div>
                        <div class="col-sm-6">
                            ...
                            <input type="text" maxlength="70" name="sub_title[]" value="{{ $news_letter_sub_title_translate[$lang]['value'] ?? '' }}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                        </div>
                    </div>
                    @empty
                    @endforelse
            ...
            <div class="d-flex justify-content-between __gap-12px mb-3">
                <h5 class="card-title d-flex align-items-center">
                    <span class="card-header-icon mr-2">
                        <img src="{{asset('assets/admin/img/fixed_data2.png')}}" alt="" class="mw-100">
                    </span>
                    ...
                    <div class="row g-3 lang_form default-form" >
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea rows="5" maxlength="300"  class="form-control" name="footer_data[]" placeholder="{{translate('messages.Short_Description')}}">{{ $footer_data?->getRawOriginal('value') ?? null}}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-3  d-none lang_form" id="{{$lang}}-form1">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control"  maxlength="300" name="footer_data[]" placeholder="{{translate('messages.Short_Description')}}">{{ $footer_data_translate[$lang]['value'] ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                        @empty
