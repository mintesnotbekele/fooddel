        ...
        <div class="d-flex justify-content-between __gap-12px mt-3 mb-2">
            <h5 class="title mr-2 d-flex align-items-center">
                {{-- <span class="card-header-icon mr-2">
                    <img src="{{asset('assets/admin/img/seller.png')}}" alt="" class="mw-100">
                </span> --}}
                <span class="card-header-icon mr-2">
                ...
                <form action="{{ route('admin.react_landing_page.settings', 'react-download-apps-banner-image') }}" enctype="multipart/form-data"     method="post">
                    ...
                    <div class="position-relative d-inline-block">
                        <label class="upload-img-3 upload-image-5 border--dashed border-1px m-0 rounded border-9EADC1">
                            <div class="img">
                                <img src="{{asset('storage/app/react_download_apps_image')}}/{{$react_download_apps_banner_image?->value}}" onerror='this.src="{{asset('/assets/admin/img/upload.png')}}"' alt="">
                            </div>
                            ...
                            <div class="lang_form default-form">
                                <div class="row g-3">
                                        ...
                                        data-original-title="{{ translate('Write_the_subtitle_within_100_characters') }}">
                                            ...
                                            <input type="text" maxlength="100" class="form-control" placeholder="{{translate('Enter_Sub_Title')}}" name="react_download_apps_sub_title[]"  value="{{ $react_download_apps_sub_title?->getRawOriginal('value') ?? '' }}">
                                        </div>
                                        <div class="col-12">
                                    ...
                                    <div class="d-none lang_form" id="{{$lang}}-form1">
                                        ...
                                        data-original-title="{{ translate('Write_the_subtitle_within_100_characters') }}">
                                            <i class="tio-info-outined"></i>
                                                    ...
                                                    <input type="text" maxlength="100" class="form-control" placeholder="{{translate('Enter_Sub_Title')}}" name="react_download_apps_sub_title[]" value="{{ $react_download_apps_sub_title_translate[$lang]['value'] ?? ''}}">
                                                </div>
                                                <div class="col-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="position-relative d-inline-block">
                                    <label class="upload-img-3 m-0">
                                        <div class="img">
                                            <img src="{{asset('storage/app/react_download_apps_image')}}/{{$react_download_apps_image?->value}}" onerror='this.src="{{asset('/assets/admin/img/upload-3.png')}}"' class="vertical-img max-w-187px" alt="">
                                        </div>
                        ...
                        <div class="row g-3 mt-3">
                            <div class="col-md-6">
                                <h5 class="card-title mb-3">
                                    <img src="http://localhost/stackfood/assets/admin/img/andriod.png" class="mr-2" alt="">
                            ...
                            <div class="col-md-6">
                                <h5 class="card-title mb-3">
                                    <img src="http://localhost/stackfood/assets/admin/img/apple.png" class="mr-2" alt="">
