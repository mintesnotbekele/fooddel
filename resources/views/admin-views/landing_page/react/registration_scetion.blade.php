            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.react_landing_page.settings', 'react-regisrtation-section-content') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative d-inline-block">
                                <label class="upload-img-3 m-0">
                                    <div class="img">
                                        <img src="{{ asset('storage/app/react_restaurant_section_image') }}/{{ $react_restaurant_section_image?->value }}"
                                            onerror='this.src="{{ asset('/assets/admin/img/upload-3.png') }}"' class="vertical-img max-w-187px"
                                            alt="">
                                    </div>
                    ...
                    <div class="d-flex justify-content-between __gap-12px mb-3">
                        <h5 class="card-title d-flex align-items-center">
                            <span class="card-header-icon mr-2">
                                <img src="{{ asset('assets/admin/img/reg_dm.png') }}" alt=""
                                    class="mw-100">
                            </span>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative d-inline-block">
                                ...
                                <label class="upload-img-3 m-0">
                                    <div class="img">
                                        <img src="{{ asset('storage/app/react_delivery_section_image') }}/{{ $react_delivery_section_image?->value }}"
