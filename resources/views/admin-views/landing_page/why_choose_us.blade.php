        ...
        <div class="card-body">
            <div class="row g-3 lang_form" id="default-form">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" maxlength="20" name="why_choose_us_title[]" value="{{ $why_choose_us_title?->getRawOriginal('value') ?? null}}" class="form-control" placeholder="{{translate('Enter_Title')}}" >
                </div>
                <div class="col-sm-6">
                    ...
                    <input type="text" maxlength="70" name="why_choose_us_sub_title[]" value="{{ $why_choose_us_sub_title?->getRawOriginal('value') ?? null}}" class="form-control" placeholder="{{translate('Enter_Title')}}" >
                </div>
            </div>
            @if($language)
            @foreach(json_decode($language) as $lang)
            ...
            <div class="row g-3 d-none lang_form" id="{{$lang}}-form">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" maxlength="20" name="why_choose_us_title[]" value="{{ $why_choose_us_title_translate[$lang]['value'] ?? '' }}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                </div>
                <div class="col-sm-6">
                    ...
                    <input type="text" maxlength="70" name="why_choose_us_sub_title[]" value="{{ $why_choose_us_sub_title_translate[$lang]['value'] ?? '' }}" class="form-control" placeholder="{{translate('Enter_Title')}}">
                </div>
            </div>
            @endforeach
            @endif
                ...
                <div class="col-md-6">
                    <div class="max-w-555px">
                        <div class="form-group lang_form default-form">
                            ...
                            <input type="text" name="title[]" maxlength="30" class="form-control" placeholder="{{translate('Enter_Title')}}" value="{{ $data_1?->getRawOriginal('value') ?? ''}}" >
                            <input type="hidden" name="lang[]" value="default">
                        </div>
                        ...
                        <div class="form-group d-none lang_form" id="{{$lang}}-form1">
                            ...
                            <input type="text" name="title[]" maxlength="30" class="form-control" placeholder="{{translate('Enter_Title')}}" value="{{ $why_choose_us_title_1_translate[$lang]['value'] ?? '' }}">
                        </div>
                        @empty
                        @endforelse
                        @endif
                        <div class="d-flex flex-column">
                            ...
                            <div class="position-relative">
                                ...
                                <label class="upload-img-3 m-0 d-block my-auto">
                                    <div class="img">
                                        <img src="{{asset('storage/app/why_choose_us_image')}}/{{$data_1_image?->value}}" onerror="this.src='{{asset("/assets/admin/img/upload-5.png")}}'" class="vertical-img max-w-555px" alt="">
                                    </div>
                ...
                <div class="col-md-6">
                    <div class="max-w-555px">
                        <div class="form-group lang_form default-form">
                            ...
                            <input type="text" name="title[]" maxlength="30" class="form-control" placeholder="{{translate('Enter_Title')}}" value="{{ $data_2?->getRawOriginal('value') ?? ''}}" >
                            <input type="hidden" name="lang[]" value="default">
                        </div>
                        ...
                        <div class="form-group d-none lang_form" id="{{$lang}}-form2">
                            ...
                            <input type="text" name="title[]" maxlength="30" class="form-control" placeholder="{{translate('Enter_Title')}}" value="{{ $why_choose_us_title_2_translate[$lang]['value'] ?? '' }}">
                        </div>
                        @empty
                        @endforelse
                        @endif
                        <div class="d-flex flex-column">
                            ...
                            <div class="position-relative">
                                ...
                                <label class="upload-img-3 m-0 d-block my-auto">
                                    <div class="img">
                                        <img src="{{asset('storage/app/why_choose_us_image')}}/{{$data_2_image?->value}}" onerror="this.src='{{asset("/assets/admin/img/upload-5.png")}}'" class="vertical-img max-w-555px" alt="">
                                    </div>
                                    <input type="file" name="image" hidden="">
                                </label>
                ...
                <div class="col-md-6">
                    <div class="max-w-555px">
                        <div class="form-group lang_form default-form">
                            ...
                            <input type="text" name="title[]" maxlength="30" class="form-control" placeholder="{{translate('Enter_Title')}}" value="{{ $data_3?->getRawOriginal('value')?? ''}}" >
                            <input type="hidden" name="lang[]" value="default">
                        </div>
                        ...
                        <div class="form-group d-none lang_form" id="{{$lang}}-form3">
                            ...
                            <input type="text" name="title[]" maxlength="30" class="form-control" placeholder="{{translate('Enter_Title')}}" value="{{ $why_choose_us_title_3_translate[$lang]['value'] ?? '' }}">
                        </div>
                        @empty
                        @endforelse
                        @endif
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="position-relative">
                                ...
                                <label class="upload-img-3 m-0 d-block my-auto">
                                    <div class="img">
                                        <img src="{{asset('storage/app/why_choose_us_image')}}/{{$data_3_image?->value}}" onerror="this.src='{{asset("/assets/admin/img/upload-5.png")}}'" class="vertical-img max-w-555px" alt="">
                                    </div>
                                    <input type="file" name="image" hidden="">
                                </label>
                ...
                <div class="col-md-6">
                    <div class="max-w-555px">
                        <div class="form-group lang_form default-form">
                            ...
                            <input type="text" name="title[]" maxlength="30" class="form-control" placeholder="{{translate('Enter_Title')}}" value="{{ $data_4?->getRawOriginal('value') ?? ''}}" >
                            <input type="hidden" name="lang[]" value="default">
                        </div>
                        ...
                        <div class="form-group d-none lang_form" id="{{$lang}}-form4">
                            ...
                            <input type="text" name="title[]" maxlength="30" class="form-control" placeholder="{{translate('Enter_Title')}}" value="{{ $why_choose_us_title_4_translate[$lang]['value'] ?? '' }}">
                        </div>
                        @empty
                        @endforelse
                        @endif
                        <div class="d-flex flex-column">
                            ...
                            <div class="position-relative">
                                ...
                                <label class="upload-img-3 m-0 d-block my-auto">
                                    <div class="img">
                                        <img src="{{asset('storage/app/why_choose_us_image')}}/{{$data_4_image?->value}}" onerror="this.src='{{asset("/assets/admin/img/upload-5.png")}}'" class="vertical-img max-w-555px" alt="">
                                    </div>
                                    <input type="file" name="image" hidden="">
                                </label>
