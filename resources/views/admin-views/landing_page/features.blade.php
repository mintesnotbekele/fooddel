                        ...
                        <div class="col-md-6 lang_form default-form">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" maxlength="20"  name="name[]" class="form-control" placeholder="{{translate('Ex:_John')}}">
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="description[]" maxlength="70"  placeholder="{{translate('Very_Good_Company')}}" class="form-control h92px"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 d-none lang_form" id="{{$lang}}-form1">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="name[]" maxlength="20" class="form-control" placeholder="{{translate('Ex:_John')}}">
                                </div>
                        ...
                        <table class="table table-borderless table-thead-bordered table-align-middle table-nowrap card-table m-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{asset('storage/app/feature_image')}}/{{$feature->image}}"
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            ...
                                            onclick="form_alert_feature('feature-{{$feature['id']}}','{{ translate('Want_to_delete_this_feature?') }}','{{ translate('If_yes,_it_will_be_removed_from_the_feature_list?') }}')" title="{{translate('messages.delete_feature')}}"><i class="tio-delete-outlined"></i>
                                            </a>
