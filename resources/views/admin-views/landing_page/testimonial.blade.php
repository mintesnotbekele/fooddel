    ...
    <div class="content container-fluid">
        ...
        <form action="{{ route('admin.landing_page.testimonial_store',) }}" method="post" enctype="multipart/form-data" >
            ...
            <h5 class="card-title mb-3 mt-3">
                <span class="card-header-icon mr-2"><i class="tio-settings-outlined"></i></span> <span>{{translate('Testimonial_List_Section')}}</span>
            </h5>
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label">{{translate('Reviewer_Name')}}</label>
                                    <input type="text" maxlength="191" required name="name" class="form-control" placeholder="{{translate('Ex:_John')}}">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">{{translate('Designation')}}</label>
                                    <input type="text" maxlength="191" required name="designation" class="form-control" placeholder="{{translate('Ex:_CTO')}}">
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <textarea name="review" maxlength="300" required placeholder="{{translate('Very_Good_Company')}}" class="form-control h92px"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex gap-40px">
                                <div>
                                    <label class="form-label d-block mb-2">
                                        {{translate('Reviewer_Image*')}}  <span class="text--primary">(1:1)</span>
                                    </label>
                                    <label class="upload-img-3 m-0 d-block">
                                        <div class="img">
                                            <img src="{{asset("/assets/admin/img/aspect-1.png")}}"  class="vertical-img max-w-187px" alt="">
                                        </div>
                                ...
                                {{-- <div class="d-flex flex-column">
                                    ...
                                    <label class="upload-img-3 m-0 d-block my-auto">
                                        <div class="img">
                                            <img src="{{asset("/assets/admin/img/aspect-3-1.png")}}"  class="vertical-img max-w-187px" alt="">
                                        </div>
                        ...
                        <table class="table table-borderless table-thead-bordered table-align-middle table-nowrap card-table m-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{asset('storage/app/reviewer_image')}}/{{$review->reviewer_image}}"
                                        onerror="this.src='{{asset('/assets/admin/img/upload-3.png')}}'" class="__size-105" alt="">
                                    </td>
                                    {{-- <td>
                                        <img src="{{asset('storage/app/reviewer_image')}}/{{$review->company_image}}"
                                        onerror="this.src='{{asset('/assets/admin/img/upload-3.png')}}'" class="__size-105" alt="">
                                    </td> --}}
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm">
                                            <input type="checkbox" class="toggle-switch-input" onclick="toogleStatusModal(event,'testimonial_status_{{$review->id}}','testimonial-on.png','testimonial-off.png',`{{translate('By_Turning_ON')}} <strong>{{translate('This_testimonial')}}`,`{{translate('By_Turning_OFF ')}} <strong>{{translate('This_testimonial')}}`,`<p>{{translate('This_section_will_be_enabled._You_can_see_this_section_on_your_landing_page.')}}</p>`,`<p>{{translate('This_section_will_be_disabled._You_can_enable_it_in_the_settings')}}</p>`)"
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            ...
                                            onclick="form_alert('review-{{$review['id']}}','{{ translate('Want_to_delete_this_review_?') }}')" title="{{translate('messages.delete_review')}}"><i class="tio-delete-outlined"></i>
                                            </a>
