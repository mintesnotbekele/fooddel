    ...
    <div class="card">
        <div class="card-header py-2">
            <div class="search--button-wrapper">
                ...
                <button type="button" onclick="form_alert('discount-{{$restaurant->id}}','{{ translate('Want_to_remove_discount_?') }}')" class="btn btn--danger"><i class="tio-delete-outlined"></i> {{translate('messages.delete')}}</button>
                @endif
            </div>
        </div>
        <div class="card-body">
