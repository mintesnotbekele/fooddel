            ...
            <div class="card bg--1 h-100">
                <div class="card-body text-center d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="d-flex align-items-center justify-content-center mt-3">
                        <img class="cash-icon mr-3" src="{{asset('/assets/admin/img/transactions/cash.png')}}"
                            alt="transactions">
            ...
            <div class="row g-3">
                ...
                <div class="col-sm-6">
                    <div class="resturant-card  bg--1">
                        ...
                        <img class="resturant-icon" src="{{asset('/assets/admin/img/transactions/earning.png')}}"
                            alt="transactions">
                    </div>
                </div>
                        ...
                        <div class="resturant--info-address">
                            <div class="avatar avatar-xxl avatar-circle avatar-border-lg">
                                <img class="avatar-img"
                                    ...
                                    src="{{asset('storage/app/vendor')}}/{{$restaurant->vendor->image}}"
            ...
            <div class="col-lg-12  mt-2">
                <div class="card ">
                    ...
                    <div class="card-header justify-content-between align-items-center">
                        ...
                        <h5 class="card-title m-0 d-flex align-items-center">
                            <span class="card-header-icon mr-2">
                                <img src="{{ asset('/assets/admin/img/company.png') }}"
                                    alt="">
                            </span>
                            ...
                            <span class="ml-1">{{ translate('Additional_Information') }}  <span data-toggle="tooltip" data-placement="right"
                                ...
                                <img src="{{ asset('/assets/admin/img/info-circle.svg') }}" alt="info"></span> </span>
                        </h5>
                    </div>
                    ...
                    <div class="card-header justify-content-between align-items-center">
                        {{-- <label class="input-label text-capitalize d-inline-flex align-items-center m-0">
                            ...
                            <span data-toggle="tooltip" data-placement="right"
                                ...
                                class="input-label-secondary">
                                <img src="{{ asset('/assets/admin/img/info-circle.svg') }}" alt="info"></span>
                        </label> --}}
                        ...
                        <div class="d-flex flex-wrap gap-4 align-items-start">
                                @foreach (json_decode($restaurant->additional_documents, true) as $key => $item)
                                    @foreach ($item as $file)
                                            <?php
                                                $path_info = pathinfo('storage/app/additional_documents/' . $file);
                                        ...
                                        @if (in_array($f_date, ['pdf', 'doc', 'docs', 'docx' ]))
                                                @if ($f_date == 'pdf')
                                                    <div class="attachment-card min-w-260">
                                                        ...
                                                        <a href="{{ asset('storage/app/additional_documents/'.$file) }}" target="_blank" rel="noopener noreferrer">
                                                            <div class="img">
                                                                    {{-- <iframe src='https://view.officeapps.live.com/op/embed.aspx?src={{ asset('storage/app/additional_documents/'.$file) }}' width='px' height='px' frameborder='0'>
                                                                    </iframe> --}}
                                                                    <iframe src="https://docs.google.com/gview?url={{ asset('storage/app/additional_documents/' . $file) }}&embedded=true"></iframe>
                                                                    {{-- <img src="{{ asset('/assets/admin/new-img/attachment.png') }}"
                                                                    alt=""> --}}
                                                            </div>
                                                                </a>
                                                        {{-- <iframe src='https://view.officeapps.live.com/op/embed.aspx?src={{ asset('
                                                            storage/app/additional_documents/'.$item) }}' width='px' height='px'
                                                            frameborder='0'>
                                                        </iframe> --}}

                                                        <a href="{{ asset('storage/app/additional_documents/' . $file) }}" download
                                                            class="download-icon mt-3">
                                                            <img src="{{ asset('/assets/admin/new-img/download-icon.svg') }}" alt="">
                                                        </a>
                                                        <a href="#" class="pdf-info">
                                                            <img src="{{ asset('/assets/admin/new-img/pdf.png') }}" alt="">
                                                    ...
                                                    <div class="attachment-card  min-w-260">
                                                        ...
                                                        <a href="#" class="pdf-info">
                                                            <img src="{{ asset('/assets/admin/new-img/doc.png') }}" alt="">
                                                            <div class="w-0 flex-grow-1">
                            ...
                            @foreach (json_decode($restaurant->additional_documents, true) as $key => $item)
                                @foreach ($item as $file)
                                    ...
                                    <div class="attachment-card max-w-360">
                                        ...
                                        <img src="{{ asset('storage/app/additional_documents/' . $file) }}" {{--
