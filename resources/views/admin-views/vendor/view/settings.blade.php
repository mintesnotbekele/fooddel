                        ...
                        <div class="form-group mb-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border  rounded px-3 form-control" for="instant_order">
                                <span class="pr-2 d-flex">
                                    ...
                                    <span  data-toggle="tooltip" data-placement="right" data-original-title='{{translate("If_enabled,_customers_can_instantly_order_from_this_restaurant._Otherwise,_customers_can_only_place_“scheduled_orders”.")}}' class="input-label-secondary">
                                        <i class="tio-info-outined"></i>
                                    </span>
                                </span>
                                <input type="checkbox" class="toggle-switch-input"
                                onclick="toogleStatusModal(event,'instant_order','veg-on.png','veg-off.png','{{translate('Want_to_enable_instant_order_for_this_restaurant?')}}','{{translate('Want_to_disable_instant_order_for_this_restaurant?')}}',`<p>{{translate('If_enabled,_customers_can_order_instantly.')}}</p>`,`<p>{{translate('If_disabled,_customers_can_not_order_instantly.')}}</p>`)"
                                 id="instant_order" {{$restaurant->restaurant_config?->instant_order == 1?'checked':''}}>
                                <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
                            <form action="{{route('admin.restaurant.toggle-settings',[$restaurant->id,$restaurant->restaurant_config?->instant_order?0:1, 'instant_order'])}}" method="get" id="instant_order_form">
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-md-4 col-sm-6">
                        <div class="form-group mb-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border  rounded px-3 form-control" for="customer_date_order_sratus">
                                <span class="pr-2 d-flex">
                                    <span class="line--limit-1">
                                        {{translate('messages.custom_date_order_sratus')}}
                                    </span>
                                    <span  data-toggle="tooltip" data-placement="right" data-original-title='{{translate("If_enabled,_customers_can_choose_a_custom_date_during_scheduled_order_placement.")}}' class="input-label-secondary">
                                        <i class="tio-info-outined"></i>
                                    </span>
                                </span>
                                <input type="checkbox" class="toggle-switch-input"
                                onclick="toogleStatusModal(event,'customer_date_order_sratus','schedule-on.png','schedule-off.png','{{translate('Want_to_enable_customer_date_order_sratus_for_this_restaurant?')}}','{{translate('Want_to_disable_customer_date_order_sratus_for_this_restaurant?')}}',`<p>{{translate('If_enabled,_customers_can_not_select_schedule_date_over_the_given_days._and_you_must_set_a_date_on_the')}} <b>{{ translate('Customer_Can_Order_Within_field') }}</b></p>`,`<p>{{translate('If_disabled,_customers_can_select_any_schedule_date.')}}</p>`)"
                                id="customer_date_order_sratus" {{$restaurant->restaurant_config?->customer_date_order_sratus == 1?'checked':''}}>
                                <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
                            <form action="{{route('admin.restaurant.toggle-settings',[$restaurant->id,$restaurant->restaurant_config?->customer_date_order_sratus?0:1, 'customer_date_order_sratus'])}}" method="get" id="customer_date_order_sratus_form">
                            </form>
                        </div>
                    </div>
                    @endif
                ...
                <div class="row g-2 mt-4">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="minimum_order" step="0.01" min="0" max="100000" class="form-control" placeholder="{{ translate('messages.Ex:_100') }} " value="{{$restaurant->minimum_order??'0'}}">
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="number" id="tax" min="0" max="10000" step="0.01" name="tax" class="form-control" placeholder="{{ translate('messages.Ex:_100') }} " required value="{{$restaurant->tax??'0'}}" {{isset($restaurant->tax)?'':'readonly'}}>
                        </div>
                    </div>
                    {{-- <div class="col-lg-4 col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group">
                            <label class="input-label text-capitalize" for="title">{{ translate('Customer_Can_Order_Within') }} ({{ translate('messages.Days') }})
                                <span data-toggle="tooltip" data-placement="right" data-original-title="{{translate('Enter_the_number_of_days_customers_can_select_for_scheduled_orders.')}}" class="input-label-secondary"><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="i"></span>
                            </label>
                            <input type="number" name="customer_order_date"  id="customer_order_date" {{ $restaurant?->restaurant_config?->customer_date_order_sratus == 1 ? 'required' :'readonly' }} min="0" max="99999999" class="form-control" placeholder="30" value="{{ $restaurant?->restaurant_config?->customer_order_date ?? '' }}">
                        </div>
                    </div>
                    @endif
            </div>
