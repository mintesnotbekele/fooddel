...
@push('css_or_js')
    ...
    <link rel="stylesheet" href="{{asset('/assets/landing/owl/dist/assets/owl.carousel.css')}}">
            ...
            <div class="card-body">
                ...
                <div class="bg-FCFCFC d-flex flex-wrap">
                    <div class="__billing-item">
                        <img src="{{asset('/assets/admin/img/subscription/1.png')}}" alt="img/subscription">
                    ...
                    <div class="__billing-item">
                        <img src="{{asset('/assets/admin/img/subscription/2.png')}}" alt="img/subscription">
                        <div class="flex-grow pl-3 pl-sm-4">
                    ...
                    <div class="__billing-item">
                        <img src="{{asset('/assets/admin/img/subscription/3.png')}}" alt="img/subscription">
                        <div class="flex-grow pl-3 pl-sm-4">
                ...
                <div class="mt-4 pt-2">
                    <h4 class="card-title mb-4">
                        <span class="card-header-icon">
                            <img class="w-20px" src="{{asset('/assets/admin/img/subscription-plan.png')}}" alt="">
                        </span>
                    ...
                    <div class="__btn-container btn--container justify-content-end">
                                ...
                                onclick="form_alert('subscription-{{ $restaurant->id }}','{{ translate('messages.You_want_to_Cancel_the_Plan_for') }} {{ $restaurant->name }}')"
                            ...
                            @if (\App\CentralLogics\Helpers::subscription_check())
                            <button class="btn btn--primary" data-toggle="modal" data-target="#subscription-modal">
                            <span class="ml-1">{{ translate('Change_/_Renew_Subscription_Plan') }}</span> </button>
                            @endif
                        </div>
                        ...
                        <div class="__plan">
                            <div class="plan-header">
                                <h3 class="title">
                                    ...
                                    <img class="check-plan-icon" src="{{asset('/assets/landing/img/check3.svg')}}" alt="">
                                </h3>
                                <div class="duration">
                            ...
                            <ul class="plan-info">
                                @if ($package->pos)
                                <li>
                                    <img class="plan-info-icon" src="{{asset('/assets/landing/img/check2.svg')}}" alt=""> {{ translate('messages.POS') }}
                                </li>
                                @endif
                                @if ($package->mobile_app)
                                <li>
                                    <img class="plan-info-icon" src="{{asset('/assets/landing/img/check2.svg')}}" alt=""> {{ translate('messages.mobile_app') }}
                                </li>
                                @endif
                                @if ($package->chat)
                                <li>
                                    <img class="plan-info-icon" src="{{asset('/assets/landing/img/check2.svg')}}" alt=""> {{ translate('messages.chatting_options') }}
                                </li>
                                @endif
                                @if ($package->review)
                                <li>
                                    <img class="plan-info-icon" src="{{asset('/assets/landing/img/check2.svg')}}" alt=""> {{ translate('messages.review_section') }}
                                </li>
                                @endif
                                @if ($package->self_delivery)
                                <li>
                                    <img class="plan-info-icon" src="{{asset('/assets/landing/img/check2.svg')}}" alt=""> {{ translate('messages.self_delivery') }}
                                </li>
                                @endif
                                @if ($package->max_order == 'unlimited')
                                <li>
                                    <img class="plan-info-icon" src="{{asset('/assets/landing/img/check2.svg')}}" alt=""> {{ translate('messages.Unlimited_Orders') }}
                                </li>
                                @else
                                <li>
                                    <img class="plan-info-icon" src="{{asset('/assets/landing/img/check2.svg')}}" alt=""> {{ $package->max_order }} {{ translate('messages.Orders') }}
                                </li>
                                @endif
                                @if ($package->max_product == 'unlimited')
                                <li>
                                    <img class="plan-info-icon" src="{{asset('/assets/landing/img/check2.svg')}}" alt=""> {{ translate('messages.Unlimited_uploads') }}
                                </li>
                                @else
                                <li>
                                    <img class="plan-info-icon" src="{{asset('/assets/landing/img/check2.svg')}}" alt=""> {{ $package->max_product }} {{ translate('messages.uploads') }}
                                </li>
                                @endif
...
@push('script_2')
<script type="text/javascript" src="{{asset('/assets/landing/owl/dist/owl.carousel.min.js')}}"></script>
<script>
