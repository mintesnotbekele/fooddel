        ...
        <div class="d-flex flex-wrap mb-4" style="gap:15px">
            ...
            <div class="page-header-select-wrapper flex-grow-1">
                ...
                <div class="select-item">
                    ...
                    data-placeholder="{{translate('messages.Business_Model')}}" class="form-control js-select2-custom">
                            ...
                            @foreach($restaurants as $key=>$dm)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img onerror="this.src='{{asset('assets/admin/img/100x100/food-default-image.png')}}'"
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                                ...
                                                onclick="request_alert('{{route('admin.restaurant.application',[$dm['id'],0])}}','{{translate('messages.you_want_to_deny_this_application')}}')"
                                                    href="javascript:"><i
                                                    class="tio-clear"></i></a>
                                        </div>
