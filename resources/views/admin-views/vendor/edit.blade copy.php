        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h2 class="page-header-title"><div class="card-header-icon"><i class="tio-edit"></i></div> {{ translate('messages.update_restaurant') }}</h2>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                ...
                <div id="vendor_form" class="form-container">
                        ...
                        <div class="card-header">
                            <h5 class="card-title">
                                <div class="card-header-icon">
                                    <i class="tio-museum"></i> {{ translate('messages.restaurant_info') }}
                                </div>
                            </h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-md-6 col-lg-4 col-12">
                                    <div class="form-group lang_form" id="default-form">
                                        <label class="input-label" for="exampleFormControlInput1">{{ translate('messages.restaurant_name') }} ({{translate('messages.default')}})</label>
                                            <input type="text" name="name[]" class="form-control" placeholder="{{ translate('messages.restaurant_name') }}" maxlength="191" value="{{$restaurant['name']}}" required oninvalid="document.getElementById('en-link').click()">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label class="input-label" for="address">{{ translate('messages.restaurant_address') }}</label>
                                        <input id="address" type="text"  name="address" class="form-control" placeholder="{{ translate('messages.restaurant_address') }}" value="{{ $restaurant->address }}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="row mt-4 pt-lg-3">
                                <div class="col-md-6 col-lg-4 col-12">
                                    <center>
                                        <img class="initial-57-1" id="viewer" onerror="this.src='{{ asset('assets/admin/img/100x100/restaurant-default-image.png') }}'" src="{{ asset('storage/app/restaurant/' . $restaurant->logo) }}" alt="Product thumbnail" />
                                    </center>

                                    <div class="form-group">
                                        <label class="input-label">{{ translate('messages.restaurant_logo') }}<small class="text-danger"> (
                                                {{ translate('messages.ratio_1:1')}}
                                                )</small></label>
                                ...
                                <div class="col-md-6 col-lg-4 col-12">
                                    <div class="cover-photo">
                                        <center>
                                            <img class="initial-57-1" id="coverImageViewer" onerror="this.src='{{ asset('assets/admin/img/300x100/restaurant-default-image.png') }}'" src="{{ asset('storage/app/restaurant/cover/' . $restaurant->cover_photo) }}"
                                                alt="Product thumbnail" />
                                        </center>

                                        <div class="form-group">
                                            <label for="name">{{ translate('messages.upload_cover_photo') }} <span
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h5 class="card-title">
                                <div class="card-header-icon">
                                    <i class="tio-user"></i> {{ translate('messages.vendor_info') }}
                                </div>
                            </h5>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h5 class="card-title">
                                <div class="card-header-icon">
                                    <i class="tio-user"></i> {{ translate('messages.login_info') }}
                                </div>
                            </h5>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="btn--container justify-content-end">
                            ...
                            <button type="submit" class="btn btn--primary"><i class="tio-save-outlined"></i> {{ translate('messages.save_info') }}</button>
                        </div>
