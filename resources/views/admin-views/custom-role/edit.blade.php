    ...
    <div class="page-header">
        <h1 class="page-header-title mb-2 text-capitalize">
            <div class="card-header-icon d-inline-flex mr-2 img">
                <img src="{{asset('/assets/admin/img/role.png')}}" alt="public">
            </div>
            <span>
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="col-md-3">
                                <div class="form-group form-check">
                                    ...
                                    <label class="form-check-label  text-dark" for="attribute">{{translate('messages.attribute')}}</label>
                                </div>
                            </div> --}}
                            <div class="col-md-3">
                                <div class="form-group form-check">
                            ...
                            {{-- <div class="col-md-3">
                                <div class="form-group form-check">
                                    ...
                                    <label class="form-check-label  text-dark" for="custom_role">{{ translate('messages.employee_Role') }}</label>
                                </div>
                            </div> --}}
                            <div class="col-md-3">
                                <div class="form-group form-check">
                            ...
                            {{-- <div class="col-md-3">
                                <div class="form-group form-check ">
                                    ...
                                    <label class="form-check-label  text-dark" for="subscription">{{translate('messages.subscription')}}</label>
                                </div>
                            </div> --}}
                            <div class="col-md-3">
                                <div class="form-group form-check">
