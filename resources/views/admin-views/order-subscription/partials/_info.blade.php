                    ...
                    <tr>
                        ...
                        <td>
                            <a class="media align-items-center" href="{{isset($detail->food_id) ? route('admin.food.view',[$detail->food['id']]) :  route('admin.campaign.view', ['food', $detail->campaign['id']])}}">
                                ...
                                @else
                                src="{{ asset('storage/app/campaign')}}/{{ isset($detail->campaign['image']) ? $detail->campaign['image'] :'' }}"
                                @endif
                                onerror="this.src='{{asset('assets/admin/img/160x160/img2.jpg')}}'" alt="{{isset($detail->food_id) ? $detail->food['name'] : $detail->campaign['name']}} image">
                                <div class="media-body">
            ...
            @foreach($schedules as $key=>$schedule)
                <tr>
                    ...
                    <td class="table-column-pl-0 text-center">
                        ...
                        {{ $schedule->day }}
                        @endif
                        {{-- {{$schedule->type == 'weekly' ? translate('messages.'.$days[$schedule->day]) : ''}}</td> --}}
                    </td>
                        <td>
