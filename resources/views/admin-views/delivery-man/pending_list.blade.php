                ...
                <div class="card">
                    ...
                    <div class="card-header py-2">
                        <div class="search--button-wrapper">
                            ...
                            <div class="hs-unfold ">
                                <div class="select-item">
                                    <select name="vehicle_id" class="form-control js-select2-custom"
                                        onchange="set_filter('{{url()->full()}}',this.value, 'vehicle_id')">
                            ...
                            <div class="hs-unfold ">
                                <div class="select-item">
                                    <select name="job_type" class="form-control js-select2-custom"
                                        onchange="set_filter('{{url()->full()}}',this.value, 'job_type')">
