                        ...
                        @foreach (json_decode($dm->identity_image) as $key => $img)
                                    <button class="btn padding p-1" data-toggle="modal"
                                        ...
                                        <div class="gallary-card">
                                            ...
                                            src="{{ asset('storage/app/delivery-man') }}/{{ $img }}" class="avatar avatar-xxl avatar-4by3 mw-120px initial-22">
                                        </div>
                                    </button>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <img onerror="this.src='{{ asset('/assets/admin/img/900x400/img1.jpg') }}'"
                                                    src="{{ asset('storage/app/delivery-man/' . $img) }}"
                                                    class="w-100">
                                            </div>
                                                ...
                                                @if ($f_date == 'pdf')
                                                    <div class="attachment-card min-w-260">
                                                        ...
                                                        {{-- <iframe src='https://view.officeapps.live.com/op/embed.aspx?src={{ asset('
                                                            storage/app/additional_documents/dm/'.$item) }}' width='px' height='px'
                                                            frameborder='0'>
                                                        </iframe> --}}

                                                        <a href="{{ asset('storage/app/additional_documents/dm/' . $file) }}" download
