...
<main id="content" role="main" class="main pointer-event">
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-4">
                <img width="150"
                     src="{{asset('storage/app/restaurant')}}/{{\App\Models\BusinessSetting::where(['key'=>'logo'])->first()->value}}">
                <br><br>
            ...
            <div class="col-4">
                @if($order->is_guest)
                    ...
                    <strong class="float-right">Customer Name
                        : {{$customer_details['contact_person_name']}}</strong><br>
                    <strong class="float-right">Phone
                        : {{$customer_details['contact_person_number']}}</strong><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 pt-2">
                                <div class="text-right">
                                    ...
                                    <h6 class="text-capitalize color-8a8a8a">Order Type
                                ...
                                <div class="media">
                                    <div class="avatar avatar-xl mr-3">
                                        <img class="img-fluid"
                                             ...
                                             src="{{asset('storage/app/product')}}/{{$detail->product['image']}}"
