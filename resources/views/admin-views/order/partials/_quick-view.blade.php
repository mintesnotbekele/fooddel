    ...
    <div class="modal-body">
        <div class="d-flex flex-row">
            ...
            <div class="details pl-2">
                <a href="{{route('admin.food.view',$product->id)}}" class="h3 mb-2 product-title">{{$product->name}}</a>
            ...
            <div class="col-12">
                ...
                <form id="add-to-cart-form" class="mb-2">
                    ...
                    <div class="d-flex justify-content-center mt-2">
                        <button class="btn btn--primary h--45px w-40p" onclick="update_order_item()" type="button">
