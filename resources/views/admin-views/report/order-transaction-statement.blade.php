    ...
    <table class="bs-0 mb-30 px-10">
        <tr>
            ...
            <th class="content-position-y text-right">
                <img height="50" style="max-width:200px" src="{{asset("/storage/app/business/$company_web_logo")}}" alt="">
            </th>
        </tr>
    </table>
</div>
                            ...
                            <td>
                                <div class="">
                                    ...
                                    @if (isset($order_transaction->order->customer) )
                                        ...
                                        @elseif($order_transaction->order->is_guest)
                                        @php($customer_details = json_decode($order_transaction->order['delivery_address'],true))
