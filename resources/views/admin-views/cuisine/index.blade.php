                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <h2 class="page-header-title text-capitalize">
                        <div class="card-header-icon d-inline-flex mr-2 img">
                            <img src="{{asset('assets/admin/img/zone.png')}}" alt="">
                        </div>
                        <span>
                            {{translate('cuisine')}}
                        </span>
                ...
                <table id="columnSearchDatatable"
                    ...
                    @foreach($cuisine as $key=>$cu)
                        <tr>
                            ...
                            @php($img_src =  isset($cu->image) ?  asset('storage/app/cuisine').'/'.$cu['image'] : asset('assets/admin/img/900x400/img2.jpg')  )
                            <td>
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    ...
                                    onclick="form_alert('cuisine-{{$cu['id']}}','{{ translate('Want_to_delete_this_cuisine_?') }}')" title="{{translate('messages.delete_cuisine')}}"><i class="tio-delete-outlined"></i>
                                    </a>
                                </div>
                                            ...
                                            <div class="col-md-6 col-lg-12">
                                                <div class="form-group mb-0 text-center">
                                                    ...
                                                    <label class="upload-img-3 m-0 d-block my-auto">
                                                        <div class="img">
                                                            <img src="{{ asset('storage/app/cuisine').'/'.$cu['image']  }}"
                                                            onerror="this.src='{{asset("/assets/admin/img/upload-6.png")}}'"
                        ...
                        {{-- <div class="row"> --}}
                            <div class="row mt-2">
                                <div class="col-md-6 col-lg-12">
                                    <div id="output" class="form-group mb-0 text-center">
                                        ...
                                        <label class="upload-img-3 m-0 d-block my-auto">
                                            <div class="img">
                                                <img src="{{asset("/assets/admin/img/upload-6.png")}}"
                                                onerror="this.src='{{asset("/assets/admin/img/upload-6.png")}}'"
                                                class="vertical-img max-w-187px" alt="">
                                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group pt-2 mb-0">
                                    <div class="btn--container justify-content-end mt-3">
                                        <!-- Static Button -->
                                        <button id="resetButton" data-dismiss="modal" aria-label="Close" type="reset" class="btn btn--reset">{{translate('messages.reset')}}</button>
                                        <!-- Static Button -->
                                        <button type="submit" class="btn btn--primary">{{translate('messages.submit')}}</button>
                                    </div>
                                </div>
