                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="bonusCheckbox{{$bonus->id}}">
                                            <input type="checkbox" onclick="location.href='{{route('admin.customer.wallet.bonus.status',[$bonus['id'],$bonus->status?0:1])}}'" class="toggle-switch-input" id="bonusCheckbox{{$bonus->id}}" {{$bonus->status?'checked':''}}>
