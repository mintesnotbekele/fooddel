    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body p-2">
                ...
                <div class="jumbotron pt-1 pb-4 mb-0 bg-white">
                    ...
                    <p>{{ translate('5._You_can_get_restaurant_id_from_their_list,_please_input_the_right_ids.') }}</p>

                    <p>{{ translate('6._You_can_upload_your_product_images_in_product_folder_from_gallery,_and_copy_image’s_path.') }}</p>
        ...
        <form class="product-form"  id="import_form" action="{{route('admin.food.bulk-import')}}" method="POST"
            ...
            <div class="card mt-2 rest-part">
                <div class="card-body">
                    <h4 class="mb-3">{{ translate('Import_Foods_File') }}</h4>
