        ...
        <div class="card-header flex-wrap justify-content-between gap-3">
            ...
            <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <div class="w-16rem">
                    ...
                    <select name="restaurant_id" onchange="set_restaurant_filter('{{ url()->current() }}',this.value)"
                    ...
                    <tbody>
                        @foreach($disbursement_restaurants as $key => $restaurant)
                            <tr>
                                ...
                                <td>
                                    <div>
                                        {{$restaurant->withdraw_method->method_name}}
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        ...
                                        @else
                                            ...
                                            <a class="btn btn-sm btn--danger btn-outline-danger action-btn action-btn-section" href="{{route('admin.restaurant-disbursement.change-status', ['id'=>$restaurant->id,'status'=>'canceled'])}}" data-toggle="tooltip" title="{{ translate('cancel') }}">
                                                <i class="tio-clear"></i>
                                            </a>
                                            @endif
                                                            ...
                                                            <div class="item w-100">
                                                                ...
                                                                <ul class="item-list">
                                                                    <li class="d-flex flex-wrap">
                                                                        ...
                                                                        <span>:</span>
                                                                        <strong>{{$restaurant->withdraw_method->method_name}}</strong>
                                                                    </li>
                                                                    <li class="d-flex flex-wrap">
...
@push('script_2')
    <script>
        $(document).ready(function() {
            ...
            var restaurantIds = {{ $restaurant_ids }};
