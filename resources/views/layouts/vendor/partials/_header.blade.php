                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    @foreach(json_decode($lang['value'],true) as $data)
                                        @if($data['code']==$local)
                                                <img class="rounded mr-1"  width="20" src="{{ asset('/assets/admin/img/lang.png') }}" alt="">
                                                {{$data['code']}}
...
@if ($Payable_Balance == 1 &&  $cash_in_hand_overflow &&  $wallet?->balance < 0 &&  $val <=  abs($wallet?->balance)  &&  $cash_in_hand_overflow_restaurant_amount >= abs($wallet?->balance))
...
@if ($Payable_Balance == 1 &&  $cash_in_hand_overflow &&  $wallet?->balance < 0 &&  $cash_in_hand_overflow_restaurant_amount < abs($wallet?->balance))
<div class="alert __alert-2 alert-warning m-0 py-1 px-2" role="alert">
