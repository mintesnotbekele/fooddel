...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/assets/landing/assets_new/css/bootstrap.min.css')}}" />
    <link rel="stylesheet" href="{{asset('/assets/landing/assets_new/css/animate.css')}}" />
    <link rel="stylesheet" href="{{asset('/assets/landing/assets_new/css/all.min.css')}}" />
    <link rel="stylesheet" href="{{asset('/assets/landing/assets_new/css/owl.min.css')}}" />
    <link rel="stylesheet" href="{{asset('/assets/landing/assets_new/css/main.css')}}" />
    <link rel="stylesheet" href="{{ asset('assets/admin') }}/css/toastr.css">
    @php($icon = \App\CentralLogics\Helpers::get_settings('icon'))
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('storage/app/business/'. $icon ?? '') }}">
...
<body>
    ...
    <header>
        <div class="container">
            <div class="header-wrapper">
                ...
                <div class="logo">
                    <a href="/">
                        <img src="{{ asset('storage/app/business/' . $logo) }}" alt="">
                    </a>
                </div>
                ...
                @if ($lang)
                    <div class="dropdown--btn-hover position-relative">
                        <a class=" text-dark dropdown--btn border-0 px-3 header--btn text-capitalize d-flex" href="javascript:void(0)">
                            ...
                            {{-- <img class="rounded mr-2"  width="20" src="{{ asset('/assets/admin/img/lang.png') }}" alt=""> --}}
    ...
    @yield('content')
                        ...
                        <div class="footer-widget">
                            ...
                            <div class="app-btn-grp">
                                ...
                                <a href="{{ $landing_page_links['app_url_android'] }}">
                                    <img src="{{asset('/assets/landing/assets_new/img/google.svg')}}" alt="">
                                </a>
                                @endif
                            @if ($landing_page_links['app_url_ios_status'])
                                <a href="{{ $landing_page_links['app_url_ios'] }}">
                                    <img src="{{asset('/assets/landing/assets_new/img/apple.svg')}}" alt="">
                                </a>
                            </div>
                            @endif
                            @endif
        ...
        <script src="{{asset('/assets/landing/assets_new/js/jquery-3.6.0.min.js')}}"></script>
        <script src="{{asset('/assets/landing/assets_new/js/bootstrap.min.js')}}"></script>
        <script src="{{asset('/assets/landing/assets_new/js/viewport.jquery.js')}}"></script>
        <script src="{{asset('/assets/landing/assets_new/js/wow.min.js')}}"></script>
        <script src="{{asset('/assets/landing/assets_new/js/owl.min.js')}}"></script>
        <script src="{{asset('/assets/landing/assets_new/js/main.js')}}"></script>
