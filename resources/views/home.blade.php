...
@section('content')
    ...
    <section class="banner-section"
        style="background: url('{{asset('storage/app/header_image')}}/{{$landing_data['header_bg_image']}}') no-repeat center center / cover">
        ...
        <div class="container">
            <div class="banner-wrapper">
                <div class="banner-thumb wow fadeInUp">
                    <img class="main-img"
                    src="{{asset('storage/app/header_image')}}/{{ $landing_data['header_content_image']   }}"

                    alt="">
                    <div class="img-data-1">
                        <img src="{{asset('assets/landing/assets_new/img/banner/icon-1.png')}}" alt="Review">
                        <span>{{ translate('Review') }} {{ $landing_data['header_floating_total_reviews']}} +</span>
                    </div>
                    <div class="img-data-2">
                        <img src="{{asset('assets/landing/assets_new/img/banner/icon-2.png')}}" alt="Order">
                        <span>{{ translate('Order') }} {{ $landing_data['header_floating_total_order']}} +</span>
                    </div>
                    <div class="img-data-3">
                        <img src="{{asset('/assets/landing/assets_new/img/banner/icon-3.png')}}" alt="User">
        ...
        <!-- Shape 1 -->
        <div class="shape-1"><img src="{{asset('/assets/landing/assets_new/img/banner/1.png')}}" alt=""></div>
        <div class="shape-2"><img src="{{asset('/assets/landing/assets_new/img/banner/2.png')}}" alt=""></div>
        <div class="shape-3"><img src="{{asset('/assets/landing/assets_new/img/banner/3.png')}}" alt=""></div>
        <!-- Glass 1 -->
        ...
        <div class="container">
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-5 text-lg-end text-center wow fadeInLeft">
                    <img
                    src="{{asset('storage/app/about_us_image')}}/{{ $landing_data['about_us_image_content']  }}"
            ...
            <div class="feature-slider owl-theme owl-carousel">
                ...
                <div class="feature-item wow fadeInUp">
                    <div class="feature-item-icon">
                        <img
                        src="{{ asset('storage/app/feature_image') }}/{{ $feature_data['image'] }}" alt="">
                    </div>
            ...
            <ul class="nav nav-tabs nav--tabs wow fadeInUp">
               ...
               <li>
                   <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#order-your-food">
                       ...
                       src="{{ asset('assets/admin/img/order_platform_image.png') }}"
               ...
               @endif
                ...
                <li>
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#manage-restaurant">
                        <img
                        src="{{ asset('assets/admin/img/manage_your_restaurant.png') }}"
                ...
                <li>
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#earn-delivery">
                        <img
                        src="{{ asset('assets/admin/img/earn_by_delivery.png') }}"
        ...
        <div class="container">
            ...
            @if (isset($landing_data['why_choose_us_image_1']))
                ...
                <div class="choose-item wow animate__dropIn">
                                <img
                    src="{{asset('storage/app/why_choose_us_image')}}/{{ $landing_data['why_choose_us_image_1'] }}"
                    alt="Image">
            ...
            @if (isset($landing_data['why_choose_us_image_2']))
                ...
                <div class="choose-item wow animate__dropIn">
                                <img
                    src="{{asset('storage/app/why_choose_us_image')}}/{{ $landing_data['why_choose_us_image_2'] }}"
                    alt="Image">
                    <div class="choose-item-content">
                        <div class="cont">
                            <h4 class="title">
            ...
            @if (isset($landing_data['why_choose_us_image_3']))
                ...
                <div class="choose-item wow animate__dropIn">
                                <img
                    src="{{asset('storage/app/why_choose_us_image')}}/{{ $landing_data['why_choose_us_image_3'] }}"
                    alt="Image">
                    <div class="choose-item-content">
                        <div class="cont">
                            <h4 class="title">
            ...
            @if (isset($landing_data['why_choose_us_image_4']))
                <div class="choose-item wow animate__dropIn">
                                <img
                    src="{{asset('storage/app/why_choose_us_image')}}/{{ $landing_data['why_choose_us_image_4'] }}"
                    alt="Image">
                    <div class="choose-item-content">
                        <div class="cont">
                            <h4 class="title">
        ...
        <div class="container">
            <div class="row align-items-end justify-content-end">
                ...
                <div class="col-md-5 text-center">
                    ...
                    src="{{ asset('storage/app/earn_money') }}/{{  $landing_data['earn_money_reg_image']  }}"
                    alt="">
                </div>
            </div>
        </div>
