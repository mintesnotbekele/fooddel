        ...
        <div class="auth-wrapper">
            <div class="auth-wrapper-body auth-form-appear">
                ...
                <a class="auth-logo mb-5" href="javascript:">
                    <img class="z-index-2" onerror="this.src='{{ asset('/assets/admin/img/auth-fav.png') }}'"
                    @if (isset($systemlogo))
                    src="{{ asset('storage/app/business/' . $systemlogo->value) }}"
                    @else
                    src="{{asset('/assets/admin/img/auth-fav.png')}}"
                    @endif
                    >
                </a>
