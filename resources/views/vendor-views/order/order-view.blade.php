                ...
                <div class="card mb-2 mt-2">
                    ...
                    @if ($order->delivery_man)
                        <h5 class="card-title mb-3 w-100 justify-content-between">
                            ...
                            @if ( !in_array($order['order_status'], ['delivered','refund_requested','canceled','refunded','refund_request_canceled']) &&
...
<div class="card-body">
                    ...
                    @if (!$order->delivery_man && !in_array($order['order_status'], ['delivered','take_away','refund_requested','canceled','refunded','refund_request_canceled']) && (isset($order->restaurant) && ($order->restaurant->restaurant_model == 'commission'  && $order->restaurant->self_delivery_system ) ||
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a class="btn btn-primary"
                                                href="{{ route('vendor.file-manager.download', base64_encode('order/' . $img)) }}"><i
