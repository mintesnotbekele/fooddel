                ...
                <section class="shop-details-banner">
                    <div class="card">
                        <div class="card-body px-0 pt-0">
                            <img src="{{asset('storage/app/restaurant/cover/'.$shop->cover_photo)}}"  onerror="this.src='{{asset('assets/admin/img/900x400/img1.jpg')}}'"class="shop-details-banner-img" alt="">
                            <div class="shop-details-banner-content">
                                <div class="shop-details-banner-content-thumbnail">
                                    <img src="{{asset('storage/app/restaurant/'.$shop->logo)}}"  onerror="this.src='{{asset('assets/admin/img/160x160/img1.jpg')}}'" class="thumbnail" alt="">
                                ...
                                <div class="shop-details-banner-content-content">
                                    ...
                                    <div class="shop-details-model">
                                        <div class="shop-details-model-item">
                                            <img src="{{asset('/assets/admin/new-img/icon-1.png')}}" alt="">
                                        ...
                                        <div class="shop-details-model-item">
                                            <img src="{{asset('/assets/admin/new-img/icon_6.png')}}" alt="">
                                            <div class="shop-details-model-item-content">
                                            ...
                                            <img src="{{asset('/assets/admin/new-img/icon-2.png')}}" alt="">
                                            <div class="shop-details-model-item-content">
                                        ...
                                        <div class="shop-details-model-item">
                                            <img src="{{asset('/assets/admin/new-img/icon-3.png')}}" alt="">
                                            <div class="shop-details-model-item-content">
                                        ...
                                        <div class="shop-details-model-item">
                                            <img src="{{asset('/assets/admin/new-img/icon-4.png')}}" alt="">
                                            <div class="shop-details-model-item-content">
                    ...
                    <div class="card mt-3">
                        <div class="card-header justify-content-between align-items-center">
                            <label class="input-label text-capitalize d-inline-flex align-items-center m-0">
                                <span class="line--limit-1"><img src="{{asset('/assets/admin/img/company.png')}}" alt=""> <b> {{translate('Announcement')}} </b> </span>
                            ...
                            <label class="toggle-switch toggle-switch-sm m-0">
                                <input type="checkbox"  name="announcement" class="toggle-switch-input" onclick="updateStatus('{{route('vendor.business-settings.toggle-settings',[$shop->id,$shop->announcement?0:1, 'announcement'])}}')" id="announcement" {{$shop->announcement?'checked':''}} class="toggle-switch-input">
