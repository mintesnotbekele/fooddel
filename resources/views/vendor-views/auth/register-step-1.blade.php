                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <center>
                                        <img class="landing-initial-1" id="coverImageViewer" src="{{ asset('/assets/landing/img/restaurant-cover.png') }}" alt="Product thumbnail" />
                                    </center>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <center>
                                        <img class="landing-initial-1" id="logoImageViewer" src="{{ asset('/assets/landing/img/restaurant-logo.png') }}" alt="Product thumbnail" />
                                    </center>
                                    <div class="landing-input-file-grp">
