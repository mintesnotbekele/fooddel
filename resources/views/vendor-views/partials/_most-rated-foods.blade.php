...
<div class="card-header">
    <h5 class="card-header-title align-items-center d-flex">
        <img src="{{asset('/assets/admin/img/dashboard/most-rated.png')}}" alt="dashboard" class="card-header-icon mr-2 mb-1">
    ...
    <div class="row g-2">
        ...
        <div class="col-md-4 col-6">
            <a href="{{route('vendor.food.view',[$item['id']])}}" class="grid-card top--rated-food pb-4">
                <center>
                    <img class="initial-42" src="{{asset('storage/app/product')}}/{{$item['image']}}" onerror="this.src='{{asset('assets/admin/img/100x100/2.png')}}'" alt="{{$item->name}} image">
                </center>
