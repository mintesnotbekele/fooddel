    ...
    <table style="width:100%;max-width:500px;margin:0 auto;text-align:center;background:#fff">
        ...
        <tr>
            <td style="padding:0 30px 30px; text-align:left">
                ...
                <img style="width:120px;display:block;margin:10px auto" onerror="this.src='{{asset('/assets/admin/img/favicon.png')}}'" src="{{ asset('storage/app/business/' . $restaurant_logo) }}" alt="img">
                <span class="privacy">
                ...
                <span class="social" style="text-align:center">
                    ...
                    <a href="{{$item->link}}" style="margin: 0 5px;text-decoration:none">
                        <img  src="{{asset('/assets/admin/img/img/')}}/{{ $item->name }}.png" alt="{{ $item->name }}">
                    </a>
                    @endforeach
                </span>
