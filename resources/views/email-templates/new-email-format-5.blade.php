    ...
    <table dir="{{ $site_direction }}" style="width:100%;max-width:500px;margin:0 auto;text-align:center;background:#fff">
        <tr>
            <td style="padding:30px 30px 0">
                ...
                @if ($data['icon'])
                src="{{ asset('storage/app/email_template/') }}/{{ $data['icon']??'' }}"
                @else
        ...
        <tr>
            <td style="padding:0 30px 30px; text-align:left">
                ...
                @if ($logo)
                <img style="width:120px;display:block;margin:10px auto" src="{{ asset('storage/app/business/' . $logo) }}" alt="img">
                @else
                <img style="width:120px;display:block;margin:10px auto"  src="{{asset('/assets/admin/img/favicon.png')}}" alt="img">
                @endif
                <span class="privacy">
